...
public open class ExternalExternalInterfaceSerializerImpl {
    companion object {
        public fun write(buffer: SerializerBase, value: ExternalInterface): Unit {
            var valueSerializer: SerializerBase = buffer
            val valueHolderForName = value.name
            valueSerializer.writeString(valueHolderForName)
        }
        public fun read(buffer: DeserializerBase): ExternalInterface {
            var valueDeserializer: DeserializerBase = buffer
            val nameTmpResult: String = valueDeserializer.readString() as String
            var value: ExternalInterface = object: ExternalInterface { override var name = nameTmpResult}
            return value
        }
    }
}
