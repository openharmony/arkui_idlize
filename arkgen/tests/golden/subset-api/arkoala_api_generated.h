...
typedef struct Ark_CircleShape Ark_CircleShape;
...
typedef struct Ark_DraggingSizeChangeEffect Ark_DraggingSizeChangeEffect;
typedef struct Opt_DraggingSizeChangeEffect Opt_DraggingSizeChangeEffect;
...
typedef struct Ark_DrawingLattice Ark_DrawingLattice;
...
typedef struct Ark_Filter Ark_Filter;
typedef struct Opt_Filter Opt_Filter;
...
typedef struct Ark_ImageMatrix Ark_ImageMatrix;
typedef struct Opt_ImageMatrix Opt_ImageMatrix;
...
typedef struct Ark_LineMetrics Ark_LineMetrics;
typedef struct Opt_LineMetrics Opt_LineMetrics;
...
typedef struct Ark_PointerStyle Ark_PointerStyle;
typedef struct Opt_PointerStyle Opt_PointerStyle;
...
typedef struct Ark_RectHeightStyle Ark_RectHeightStyle;
typedef struct Opt_RectHeightStyle Opt_RectHeightStyle;
typedef struct Ark_RectResult Ark_RectResult;
typedef struct Opt_RectResult Opt_RectResult;
typedef struct Ark_RectWidthStyle Ark_RectWidthStyle;
typedef struct Opt_RectWidthStyle Opt_RectWidthStyle;
...
typedef struct Ark_ResolutionQuality Ark_ResolutionQuality;
typedef struct Opt_ResolutionQuality Opt_ResolutionQuality;
...
typedef struct Ark_TextBox Ark_TextBox;
typedef struct Opt_TextBox Opt_TextBox;
...
typedef struct Ark_UIContext Ark_UIContext;
...
typedef struct Ark_UnifiedData Ark_UnifiedData;
typedef struct Opt_UnifiedData Opt_UnifiedData;
typedef struct Ark_UniformDataType Ark_UniformDataType;
typedef struct Opt_UniformDataType Opt_UniformDataType;
...
typedef struct Ark_Union_NavDestinationContext_String Ark_Union_NavDestinationContext_String;
typedef struct Opt_Union_NavDestinationContext_String Opt_Union_NavDestinationContext_String;
...
typedef struct Ark_VisualEffect Ark_VisualEffect;
typedef struct Opt_VisualEffect Opt_VisualEffect;
...
typedef struct Array_TextBox Array_TextBox;
typedef struct Opt_Array_TextBox Opt_Array_TextBox;
...
typedef struct Callback_Void_Void Callback_Void_Void;
typedef struct Opt_Callback_Void_Void Opt_Callback_Void_Void;
...
typedef struct synthetic_Callback_Boolean_Void synthetic_Callback_Boolean_Void;
typedef struct Opt_synthetic_Callback_Boolean_Void Opt_synthetic_Callback_Boolean_Void;
typedef struct synthetic_Callback_KeyEvent_Void synthetic_Callback_KeyEvent_Void;
typedef struct Opt_synthetic_Callback_KeyEvent_Void Opt_synthetic_Callback_KeyEvent_Void;
typedef struct synthetic_Callback_MouseEvent_Void synthetic_Callback_MouseEvent_Void;
typedef struct Opt_synthetic_Callback_MouseEvent_Void Opt_synthetic_Callback_MouseEvent_Void;
typedef struct synthetic_Callback_Number_Void synthetic_Callback_Number_Void;
typedef struct Opt_synthetic_Callback_Number_Void Opt_synthetic_Callback_Number_Void;
typedef struct synthetic_Callback_String_Void synthetic_Callback_String_Void;
typedef struct Opt_synthetic_Callback_String_Void Opt_synthetic_Callback_String_Void;
typedef struct synthetic_Callback_TextPickerResult_Void synthetic_Callback_TextPickerResult_Void;
typedef struct Opt_synthetic_Callback_TextPickerResult_Void Opt_synthetic_Callback_TextPickerResult_Void;
typedef struct synthetic_Callback_TouchEvent_Void synthetic_Callback_TouchEvent_Void;
typedef struct Opt_synthetic_Callback_TouchEvent_Void Opt_synthetic_Callback_TouchEvent_Void;
...
typedef struct Throws_Array_SpanStyle Throws_Array_SpanStyle;
typedef struct Opt_Throws_Array_SpanStyle Opt_Throws_Array_SpanStyle;
typedef struct Throws_Boolean Throws_Boolean;
typedef struct Opt_Throws_Boolean Opt_Throws_Boolean;
typedef struct Throws_Number Throws_Number;
typedef struct Opt_Throws_Number Opt_Throws_Number;
typedef struct Throws_RectResult Throws_RectResult;
typedef struct Opt_Throws_RectResult Opt_Throws_RectResult;
typedef struct Throws_String Throws_String;
typedef struct Opt_Throws_String Opt_Throws_String;
typedef struct Throws_StyledString Throws_StyledString;
typedef struct Opt_Throws_StyledString Opt_Throws_StyledString;
typedef struct Throws_UnifiedData Throws_UnifiedData;
typedef struct Opt_Throws_UnifiedData Opt_Throws_UnifiedData;
...
typedef struct Ark_arkui_component_TranslateOptions Ark_arkui_component_TranslateOptions;
typedef struct Opt_arkui_component_TranslateOptions Opt_arkui_component_TranslateOptions;
...
typedef struct Ark_DrawingColorFilter Ark_DrawingColorFilter;
...
typedef struct Ark_EllipseShape Ark_EllipseShape;
...
typedef struct Ark_PathShape Ark_PathShape;
...
typedef struct Ark_Union_Number_String_Array_Object Ark_Union_Number_String_Array_Object;
typedef struct Opt_Union_Number_String_Array_Object Opt_Union_Number_String_Array_Object;
...
typedef struct Ark_Union_String_Number_Resource_Array_Dimension Ark_Union_String_Number_Resource_Array_Dimension;
typedef struct Opt_Union_String_Number_Resource_Array_Dimension Opt_Union_String_Number_Resource_Array_Dimension;
...
typedef struct Throws_VisibleListContentInfo Throws_VisibleListContentInfo;
typedef struct Opt_Throws_VisibleListContentInfo Opt_Throws_VisibleListContentInfo;
...
typedef struct Ark_arkui_component_Edges Ark_arkui_component_Edges;
typedef struct Opt_arkui_component_Edges Opt_arkui_component_Edges;
typedef struct Ark_arkui_component_IndicatorStyle Ark_arkui_component_IndicatorStyle;
typedef struct Opt_arkui_component_IndicatorStyle Opt_arkui_component_IndicatorStyle;
...
typedef struct Ark_Union_Dimension_Padding Ark_Union_Dimension_Padding;
typedef struct Opt_Union_Dimension_Padding Opt_Union_Dimension_Padding;
...
typedef struct Ark_Union_EdgeOutlineWidths_String_Number_Resource Ark_Union_EdgeOutlineWidths_String_Number_Resource;
typedef struct Opt_Union_EdgeOutlineWidths_String_Number_Resource Opt_Union_EdgeOutlineWidths_String_Number_Resource;
...
typedef struct Ark_Union_OutlineRadiuses_String_Number_Resource Ark_Union_OutlineRadiuses_String_Number_Resource;
typedef struct Opt_Union_OutlineRadiuses_String_Number_Resource Opt_Union_OutlineRadiuses_String_Number_Resource;
...
typedef struct Ark_Union_Padding_LocalizedPadding Ark_Union_Padding_LocalizedPadding;
typedef struct Opt_Union_Padding_LocalizedPadding Opt_Union_Padding_LocalizedPadding;
...
typedef struct Ark_Union_Position_arkui_component_Edges_LocalizedEdges Ark_Union_Position_arkui_component_Edges_LocalizedEdges;
typedef struct Opt_Union_Position_arkui_component_Edges_LocalizedEdges Opt_Union_Position_arkui_component_Edges_LocalizedEdges;
...
typedef struct Ark_Union_String_Number_Resource_BorderRadiuses Ark_Union_String_Number_Resource_BorderRadiuses;
typedef struct Opt_Union_String_Number_Resource_BorderRadiuses Opt_Union_String_Number_Resource_BorderRadiuses;
typedef struct Ark_Union_String_Number_Resource_BorderRadiuses_LocalizedBorderRadiuses Ark_Union_String_Number_Resource_BorderRadiuses_LocalizedBorderRadiuses;
typedef struct Opt_Union_String_Number_Resource_BorderRadiuses_LocalizedBorderRadiuses Opt_Union_String_Number_Resource_BorderRadiuses_LocalizedBorderRadiuses;
typedef struct Ark_Union_String_Number_Resource_EdgeWidths_LocalizedEdgeWidths Ark_Union_String_Number_Resource_EdgeWidths_LocalizedEdgeWidths;
typedef struct Opt_Union_String_Number_Resource_EdgeWidths_LocalizedEdgeWidths Opt_Union_String_Number_Resource_EdgeWidths_LocalizedEdgeWidths;
typedef struct Ark_Union_String_Number_Resource_LeadingMarginPlaceholder Ark_Union_String_Number_Resource_LeadingMarginPlaceholder;
typedef struct Opt_Union_String_Number_Resource_LeadingMarginPlaceholder Opt_Union_String_Number_Resource_LeadingMarginPlaceholder;
typedef struct Ark_Union_String_Number_Resource_Padding Ark_Union_String_Number_Resource_Padding;
typedef struct Opt_Union_String_Number_Resource_Padding Opt_Union_String_Number_Resource_Padding;
...
typedef enum Ark_AccessibilityHoverType: InteropUInt8 {
...
typedef enum Ark_AdaptiveColor: InteropUInt8 {
...
typedef enum Ark_Alignment: InteropUInt8 {
...
typedef enum Ark_AnimationStatus: InteropUInt8 {
...
typedef enum Ark_AppRotation: InteropUInt8 {
...
typedef enum Ark_ArrowPointPosition: InteropUInt8 {
...
typedef enum Ark_Axis: InteropUInt8 {
    ARK_AXIS_VERTICAL = 0,
...
typedef enum Ark_BarMode: InteropUInt8 {
...
typedef enum Ark_BarPosition: InteropUInt8 {
...
typedef enum Ark_BarState: InteropUInt8 {
    ARK_BAR_STATE_OFF = 0,
...
typedef enum Ark_BarStyle: InteropUInt8 {
...
typedef enum Ark_BlendApplyType: InteropUInt8 {
...
typedef enum Ark_BlendMode: InteropUInt8 {
...
typedef enum Ark_BlurStyle: InteropUInt8 {
...
typedef enum Ark_BlurStyleActivePolicy: InteropUInt8 {
...
typedef enum Ark_BorderStyle: InteropUInt8 {
...
typedef enum Ark_ButtonRole: InteropUInt8 {
...
typedef enum Ark_ButtonStyleMode: InteropUInt8 {
...
typedef enum Ark_ButtonType: InteropUInt8 {
...
typedef enum Ark_CalendarAlign: InteropUInt8 {
...
typedef enum Ark_CancelButtonStyle: InteropUInt8 {
...
typedef enum Ark_ChainEdgeEffect: InteropUInt8 {
...
typedef enum Ark_ChainStyle: InteropUInt8 {
...
typedef enum Ark_CheckBoxShape: InteropUInt8 {
...
typedef enum Ark_ClickEffectLevel: InteropUInt8 {
...
typedef enum Ark_Color: InteropUInt8 {
    ARK_COLOR_WHITE = 0,
    ARK_COLOR_BLACK = 1,
    ARK_COLOR_BLUE = 2,
    ARK_COLOR_BROWN = 3,
...
typedef enum Ark_ColoringStrategy: InteropUInt8 {
...
typedef enum Ark_ContentClipMode: InteropUInt8 {
...
typedef enum Ark_ContentType: InteropUInt8 {
...
typedef enum Ark_ControlSize: InteropUInt8 {
...
typedef enum Ark_CopyOptions: InteropUInt8 {
...
typedef enum Ark_Curve: InteropUInt8 {
    ARK_CURVE_LINEAR = 0,
    ARK_CURVE_EASE = 1,
    ARK_CURVE_EASE_IN = 2,
...
typedef enum Ark_DialogAlignment: InteropUInt8 {
...
typedef enum Ark_DialogButtonDirection: InteropUInt8 {
...
typedef enum Ark_DialogButtonStyle: InteropUInt8 {
...
typedef enum Ark_Direction: InteropUInt8 {
    ARK_DIRECTION_LTR = 0,
    ARK_DIRECTION_RTL = 1,
...
typedef enum Ark_DismissReason: InteropUInt8 {
...
typedef enum Ark_DpiFollowStrategy: InteropUInt8 {
...
typedef enum Ark_DragBehavior: InteropUInt8 {
...
typedef enum Ark_DragPreviewMode: InteropUInt8 {
...
typedef enum Ark_DragResult: InteropUInt8 {
...
typedef enum Ark_DynamicRangeMode: InteropUInt8 {
...
typedef enum Ark_Edge: InteropUInt8 {
    ARK_EDGE_TOP = 0,
    ARK_EDGE_CENTER = 1,
    ARK_EDGE_BOTTOM = 2,
    ARK_EDGE_BASELINE = 3,
...
typedef enum Ark_EdgeEffect: InteropUInt8 {
...
typedef enum Ark_EditMode: InteropUInt8 {
...
typedef enum Ark_EffectDirection: InteropUInt8 {
...
typedef enum Ark_EffectFillStyle: InteropUInt8 {
...
typedef enum Ark_EffectScope: InteropUInt8 {
...
typedef enum Ark_EffectType: InteropUInt8 {
...
typedef enum Ark_EllipsisMode: InteropUInt8 {
...
typedef enum Ark_EmbeddedType: InteropUInt8 {
...
typedef enum Ark_EnterKeyType: InteropUInt8 {
...
typedef enum Ark_EnumDTS: InteropUInt8 {
...
typedef enum Ark_FillMode: InteropUInt8 {
...
typedef enum Ark_FinishCallbackType: InteropUInt8 {
...
typedef enum Ark_FlexAlign: InteropUInt8 {
...
typedef enum Ark_FlexDirection: InteropUInt8 {
...
typedef enum Ark_FlexWrap: InteropUInt8 {
...
typedef enum Ark_FoldStatus: InteropUInt8 {
...
typedef enum Ark_FontStyle: InteropUInt8 {
...
typedef enum Ark_FontWeight: InteropUInt8 {
...
typedef enum Ark_FunctionKey: InteropUInt8 {
...
typedef enum Ark_GestureControl_GestureType: InteropUInt8 {
...
typedef enum Ark_GestureJudgeResult: InteropUInt8 {
...
typedef enum Ark_GestureMask: InteropUInt8 {
...
typedef enum Ark_GestureMode: InteropUInt8 {
...
typedef enum Ark_GesturePriority: InteropUInt8 {
...
typedef enum Ark_GestureRecognizerState: InteropUInt8 {
...
typedef enum Ark_GradientDirection: InteropUInt8 {
...
typedef enum Ark_HeightBreakpoint: InteropUInt8 {
...
typedef enum Ark_HitTestMode: InteropUInt8 {
...
typedef enum Ark_HorizontalAlign: InteropUInt8 {
...
typedef enum Ark_HoverEffect: InteropUInt8 {
...
typedef enum Ark_HoverModeAreaType: InteropUInt8 {
...
typedef enum Ark_IlluminatedType: InteropUInt8 {
...
typedef enum Ark_ImageAnalyzerType: InteropUInt8 {
...
typedef enum Ark_ImageContent: InteropUInt8 {
...
typedef enum Ark_ImageFit: InteropUInt8 {
...
typedef enum Ark_ImageInterpolation: InteropUInt8 {
...
typedef enum Ark_ImageRenderMode: InteropUInt8 {
...
typedef enum Ark_ImageRepeat: InteropUInt8 {
...
typedef enum Ark_ImageRotateOrientation: InteropUInt8 {
...
typedef enum Ark_ImageSize: InteropUInt8 {
...
typedef enum Ark_ImageSpanAlignment: InteropUInt8 {
...
typedef enum Ark_InputType: InteropUInt8 {
...
typedef enum Ark_ItemAlign: InteropUInt8 {
...
typedef enum Ark_KeyboardAvoidMode: InteropUInt8 {
...
typedef enum Ark_KeySource: InteropUInt8 {
...
typedef enum Ark_KeyType: InteropUInt8 {
    ARK_KEY_TYPE_DOWN = 0,
    ARK_KEY_TYPE_UP = 1,
} Ark_KeyType;
...
typedef enum Ark_LaunchMode: InteropUInt8 {
...
typedef enum Ark_LayoutMode: InteropUInt8 {
...
typedef enum Ark_LayoutSafeAreaEdge: InteropUInt8 {
...
typedef enum Ark_LayoutSafeAreaType: InteropUInt8 {
...
typedef enum Ark_LengthMetricsUnit: InteropUInt8 {
...
typedef enum Ark_LineBreakStrategy: InteropUInt8 {
...
typedef enum Ark_LineCapStyle: InteropUInt8 {
...
typedef enum Ark_LineJoinStyle: InteropUInt8 {
...
typedef enum Ark_ListItemAlign: InteropUInt8 {
...
typedef enum Ark_ListItemGroupArea: InteropUInt8 {
...
typedef enum Ark_ListItemStyle: InteropUInt8 {
...
typedef enum Ark_MarqueeUpdateStrategy: InteropUInt8 {
...
typedef enum Ark_MenuPolicy: InteropUInt8 {
...
typedef enum Ark_MenuPreviewMode: InteropUInt8 {
...
typedef enum Ark_MenuType: InteropUInt8 {
...
typedef enum Ark_ModalTransition: InteropUInt8 {
...
typedef enum Ark_ModifierKey: InteropUInt8 {
...
typedef enum Ark_MouseAction: InteropUInt8 {
...
typedef enum Ark_MouseButton: InteropUInt8 {
...
typedef enum Ark_NavBarPosition: InteropUInt8 {
...
typedef enum Ark_NavDestinationMode: InteropUInt8 {
...
typedef enum Ark_NavigationMode: InteropUInt8 {
...
typedef enum Ark_NavigationOperation: InteropUInt8 {
...
typedef enum Ark_NavigationTitleMode: InteropUInt8 {
...
typedef enum Ark_NavigationType: InteropUInt8 {
...
typedef enum Ark_NestedScrollMode: InteropUInt8 {
...
typedef enum Ark_ObscuredReasons: InteropUInt8 {
...
typedef enum Ark_OptionWidthMode: InteropUInt8 {
...
typedef enum Ark_OutlineStyle: InteropUInt8 {
...
typedef enum Ark_PanDirection: InteropUInt8 {
...
typedef enum Ark_PixelRoundCalcPolicy: InteropUInt8 {
...
typedef enum Ark_Placement: InteropUInt8 {
...
typedef enum Ark_PlayMode: InteropUInt8 {
...
typedef enum Ark_PreDragStatus: InteropUInt8 {
...
typedef enum Ark_RelateType: InteropUInt8 {
...
typedef enum Ark_RenderExitReason: InteropUInt8 {
...
typedef enum Ark_RenderFit: InteropUInt8 {
...
typedef enum Ark_RepeatMode: InteropUInt8 {
...
typedef enum Ark_ResponseType: InteropUInt8 {
...
typedef enum Ark_RichEditorDeleteDirection: InteropUInt8 {
...
typedef enum Ark_RichEditorResponseType: InteropUInt8 {
...
typedef enum Ark_RichEditorSpanType: InteropUInt8 {
...
typedef enum Ark_SafeAreaEdge: InteropUInt8 {
...
typedef enum Ark_SafeAreaType: InteropUInt8 {
...
typedef enum Ark_ScrollAlign: InteropUInt8 {
...
typedef enum Ark_ScrollDirection: InteropUInt8 {
...
typedef enum Ark_ScrollSizeMode: InteropUInt8 {
...
typedef enum Ark_ScrollSnapAlign: InteropUInt8 {
...
typedef enum Ark_ScrollSource: InteropUInt8 {
...
typedef enum Ark_ScrollState: InteropUInt8 {
...
typedef enum Ark_SearchType: InteropUInt8 {
...
typedef enum Ark_SelectedMode: InteropUInt8 {
...
typedef enum Ark_ShadowStyle: InteropUInt8 {
...
typedef enum Ark_ShadowType: InteropUInt8 {
...
typedef enum Ark_SharedTransitionEffectType: InteropUInt8 {
...
typedef enum Ark_SheetKeyboardAvoidMode: InteropUInt8 {
...
typedef enum Ark_SheetMode: InteropUInt8 {
...
typedef enum Ark_SheetSize: InteropUInt8 {
...
typedef enum Ark_SheetType: InteropUInt8 {
...
typedef enum Ark_SizeType: InteropUInt8 {
...
typedef enum Ark_SourceTool: InteropUInt8 {
...
typedef enum Ark_SourceType: InteropUInt8 {
...
typedef enum Ark_Sticky: InteropUInt8 {
    ARK_STICKY_NONE = 0,
    ARK_STICKY_NORMAL = 1,
...
typedef enum Ark_StickyStyle: InteropUInt8 {
...
typedef enum Ark_SwipeActionState: InteropUInt8 {
...
typedef enum Ark_SwipeDirection: InteropUInt8 {
...
typedef enum Ark_SwipeEdgeEffect: InteropUInt8 {
...
typedef enum Ark_SwiperDisplayMode: InteropUInt8 {
...
typedef enum Ark_SwiperNestedScrollMode: InteropUInt8 {
...
typedef enum Ark_SymbolEffectStrategy: InteropUInt8 {
...
typedef enum Ark_SymbolRenderingStrategy: InteropUInt8 {
...
typedef enum Ark_TextAlign: InteropUInt8 {
...
typedef enum Ark_TextCase: InteropUInt8 {
...
typedef enum Ark_TextContentStyle: InteropUInt8 {
...
typedef enum Ark_TextDataDetectorType: InteropUInt8 {
...
typedef enum Ark_TextDecorationStyle: InteropUInt8 {
...
typedef enum Ark_TextDecorationType: InteropUInt8 {
...
typedef enum Ark_TextDeleteDirection: InteropUInt8 {
...
typedef enum Ark_TextHeightAdaptivePolicy: InteropUInt8 {
...
typedef enum Ark_TextInputStyle: InteropUInt8 {
...
typedef enum Ark_TextOverflow: InteropUInt8 {
...
typedef enum Ark_TextSelectableMode: InteropUInt8 {
...
typedef enum Ark_ThemeColorMode: InteropUInt8 {
...
typedef enum Ark_TitleHeight: InteropUInt8 {
...
typedef enum Ark_ToggleType: InteropUInt8 {
...
typedef enum Ark_ToolbarItemStatus: InteropUInt8 {
...
typedef enum Ark_TouchTestStrategy: InteropUInt8 {
...
typedef enum Ark_TouchType: InteropUInt8 {
...
typedef enum Ark_TransitionEdge: InteropUInt8 {
...
typedef enum Ark_TransitionHierarchyStrategy: InteropUInt8 {
...
typedef enum Ark_TransitionType: InteropUInt8 {
...
typedef enum Ark_VerticalAlign: InteropUInt8 {
...
typedef enum Ark_Visibility: InteropUInt8 {
...
typedef enum Ark_Week: InteropUInt8 {
    ARK_WEEK_MON = 0,
    ARK_WEEK_TUE = 1,
    ARK_WEEK_WED = 2,
    ARK_WEEK_THUR = 3,
...
typedef enum Ark_WidthBreakpoint: InteropUInt8 {
...
typedef enum Ark_WordBreak: InteropUInt8 {
...
typedef enum Ark_XComponentType: InteropUInt8 {
...
typedef struct Ark_CircleShape {
    /* kind: Interface */
    void *handle;
} Ark_CircleShape;
...
typedef struct Ark_DraggingSizeChangeEffect {
    /* kind: Interface */
    void *handle;
...
typedef struct Ark_ImageMatrix {
    /* kind: Interface */
    void *handle;
} Ark_ImageMatrix;
typedef struct Opt_ImageMatrix {
    Ark_Tag tag;
    Ark_ImageMatrix value;
} Opt_ImageMatrix;
...
typedef struct Ark_LineMetrics {
    /* kind: Interface */
    void *handle;
} Ark_LineMetrics;
typedef struct Opt_LineMetrics {
    Ark_Tag tag;
    Ark_LineMetrics value;
} Opt_LineMetrics;
...
typedef struct Ark_PointerStyle {
    /* kind: Interface */
    void *handle;
} Ark_PointerStyle;
...
typedef struct Ark_RectHeightStyle {
    /* kind: Interface */
    void *handle;
} Ark_RectHeightStyle;
...
typedef struct Ark_RectWidthStyle {
    /* kind: Interface */
    void *handle;
} Ark_RectWidthStyle;
...
typedef struct Opt_ResolutionQuality {
    Ark_Tag tag;
    Ark_ResolutionQuality value;
} Opt_ResolutionQuality;
...
typedef struct Opt_SystemBarStyle {
    Ark_Tag tag;
...
typedef struct Ark_TextBox {
    /* kind: Interface */
    void *handle;
} Ark_TextBox;
typedef struct Opt_TextBox {
    Ark_Tag tag;
    Ark_TextBox value;
} Opt_TextBox;
...
typedef struct Ark_UnifiedData {
    /* kind: Interface */
    void *handle;
} Ark_UnifiedData;
typedef struct Opt_UnifiedData {
    Ark_Tag tag;
    Ark_UnifiedData value;
} Opt_UnifiedData;
typedef struct Ark_UniformDataType {
    /* kind: Interface */
    void *handle;
} Ark_UniformDataType;
typedef struct Opt_UniformDataType {
    Ark_Tag tag;
    Ark_UniformDataType value;
} Opt_UniformDataType;
...
typedef struct Ark_Union_NavDestinationContext_String {
    /* kind: UnionType */
    Ark_Int32 selector;
    union {
...
} Ark_Union_NavDestinationContext_String;
typedef struct Opt_Union_NavDestinationContext_String {
    Ark_Tag tag;
    Ark_Union_NavDestinationContext_String value;
} Opt_Union_NavDestinationContext_String;
...
typedef struct Ark_VisualEffect {
    /* kind: Interface */
    void *handle;
} Ark_VisualEffect;
typedef struct Opt_VisualEffect {
    Ark_Tag tag;
...
typedef struct Array_TextBox {
    /* kind: ContainerType */
    Ark_TextBox* array;
    Ark_Int32 length;
} Array_TextBox;
typedef struct Opt_Array_TextBox {
    Ark_Tag tag;
    Array_TextBox value;
} Opt_Array_TextBox;
...
typedef struct AsyncCallback_TextMenuItem_TextRange_Boolean {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_TextMenuItem menuItem, const Ark_TextRange range, const synthetic_Callback_Boolean_Void continuation);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_TextMenuItem menuItem, const Ark_TextRange range, const synthetic_Callback_Boolean_Void continuation);
...
typedef struct Callback_Any {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Callback_Object_Void continuation);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Callback_Object_Void continuation);
} Callback_Any;
...
typedef struct Callback_Boolean {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const synthetic_Callback_Boolean_Void continuation);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const synthetic_Callback_Boolean_Void continuation);
} Callback_Boolean;
...
typedef struct Callback_Callback_Any_Void {
    ...
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Callback_Any value);
...
typedef struct Callback_ClickEvent_Void {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_ClickEvent data);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_ClickEvent data);
...
typedef struct Callback_CopyEvent_Void {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_CopyEvent data);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_CopyEvent data);
...
typedef struct Callback_CutEvent_Void {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_CutEvent data);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_CutEvent data);
...
typedef struct Callback_DeleteValue_Boolean {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_DeleteValue data, const synthetic_Callback_Boolean_Void continuation);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_DeleteValue data, const synthetic_Callback_Boolean_Void continuation);
...
typedef struct Callback_DeleteValue_Void {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_DeleteValue data);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_DeleteValue data);
...
typedef struct Callback_DismissContentCoverAction_Void {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_DismissContentCoverAction data);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_DismissContentCoverAction data);
...
typedef struct Callback_DismissDialogAction_Void {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_DismissDialogAction data);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_DismissDialogAction data);
...
typedef struct Callback_DismissPopupAction_Void {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_DismissPopupAction data);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_DismissPopupAction data);
...
typedef struct Callback_DismissSheetAction_Void {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_DismissSheetAction data);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_DismissSheetAction data);
...
typedef struct Callback_FormCallbackInfo_Void {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_FormCallbackInfo data);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_FormCallbackInfo data);
...
typedef struct Callback_InsertValue_Boolean {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_InsertValue data, const synthetic_Callback_Boolean_Void continuation);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_InsertValue data, const synthetic_Callback_Boolean_Void continuation);
...
typedef struct Callback_InsertValue_Void {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_InsertValue data);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_InsertValue data);
...
typedef struct Callback_ItemDragInfo_Number_Callback_Any {
    ...
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_ItemDragInfo event, const Ark_Number itemIndex, const Callback_Callback_Any_Void continuation);
...
typedef struct Callback_KeyEvent_Boolean {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_KeyEvent data, const synthetic_Callback_Boolean_Void continuation);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_KeyEvent data, const synthetic_Callback_Boolean_Void continuation);
...
typedef struct Callback_Number_Boolean {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Number index, const synthetic_Callback_Boolean_Void continuation);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_Number index, const synthetic_Callback_Boolean_Void continuation);
...
typedef struct Callback_Number_Number_Boolean {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Number from, const Ark_Number to, const synthetic_Callback_Boolean_Void continuation);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_Number from, const Ark_Number to, const synthetic_Callback_Boolean_Void continuation);
...
typedef struct Callback_Object_Void {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Object value);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_Object value);
...
typedef struct Callback_OnHttpErrorReceiveEvent_Void {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_OnHttpErrorReceiveEvent data);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_OnHttpErrorReceiveEvent data);
...
typedef struct Callback_OnRenderExitedEvent_Void {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_OnRenderExitedEvent data);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_OnRenderExitedEvent data);
...
typedef struct Callback_Opt_Literal_Object_detail_Boolean {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Opt_Literal_Object_detail event, const synthetic_Callback_Boolean_Void continuation);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Opt_Literal_Object_detail event, const synthetic_Callback_Boolean_Void continuation);
...
typedef struct Callback_PreDragStatus_Void {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, Ark_PreDragStatus data);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, Ark_PreDragStatus data);
...
typedef struct Callback_RichEditorChangeValue_Boolean {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_RichEditorChangeValue data, const synthetic_Callback_Boolean_Void continuation);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_RichEditorChangeValue data, const synthetic_Callback_Boolean_Void continuation);
...
typedef struct Callback_RichEditorDeleteValue_Boolean {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_RichEditorDeleteValue data, const synthetic_Callback_Boolean_Void continuation);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_RichEditorDeleteValue data, const synthetic_Callback_Boolean_Void continuation);
...
typedef struct Callback_RichEditorInsertValue_Boolean {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_RichEditorInsertValue data, const synthetic_Callback_Boolean_Void continuation);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_RichEditorInsertValue data, const synthetic_Callback_Boolean_Void continuation);
...
typedef struct Callback_RichEditorRange_Void {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_RichEditorRange data);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_RichEditorRange data);
...
typedef struct Callback_RichEditorSelection_Void {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_RichEditorSelection data);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_RichEditorSelection data);
...
typedef struct Callback_RichEditorTextSpanResult_Void {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_RichEditorTextSpanResult data);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_RichEditorTextSpanResult data);
...
typedef struct Callback_SheetType_Void {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, Ark_SheetType data);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, Ark_SheetType data);
...
typedef struct Callback_SpringBackAction_Void {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_SpringBackAction data);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_SpringBackAction data);
...
typedef struct Callback_StyledStringChangeValue_Boolean {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_StyledStringChangeValue data, const synthetic_Callback_Boolean_Void continuation);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_StyledStringChangeValue data, const synthetic_Callback_Boolean_Void continuation);
...
typedef struct Callback_SwiperContentTransitionProxy_Void {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_SwiperContentTransitionProxy data);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_SwiperContentTransitionProxy data);
...
typedef struct Callback_TerminationInfo_Void {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_TerminationInfo data);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_TerminationInfo data);
...
typedef struct Callback_TextRange_Void {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_TextRange data);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_TextRange data);
...
typedef struct Callback_Void_Void {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId);
} Callback_Void_Void;
typedef struct Opt_Callback_Void_Void {
    Ark_Tag tag;
    Callback_Void_Void value;
} Opt_Callback_Void_Void;
...
typedef struct InterceptionShowCallback {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Union_NavDestinationContext_String from, const Ark_Union_NavDestinationContext_String to, Ark_NavigationOperation operation, const Ark_Boolean isAnimated);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_Union_NavDestinationContext_String from, const Ark_Union_NavDestinationContext_String to, Ark_NavigationOperation operation, const Ark_Boolean isAnimated);
...
typedef struct synthetic_Callback_Boolean_Void {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} synthetic_Callback_Boolean_Void;
typedef struct Opt_synthetic_Callback_Boolean_Void {
    Ark_Tag tag;
    synthetic_Callback_Boolean_Void value;
} Opt_synthetic_Callback_Boolean_Void;
typedef struct synthetic_Callback_KeyEvent_Void {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} synthetic_Callback_KeyEvent_Void;
typedef struct Opt_synthetic_Callback_KeyEvent_Void {
    Ark_Tag tag;
    synthetic_Callback_KeyEvent_Void value;
} Opt_synthetic_Callback_KeyEvent_Void;
typedef struct synthetic_Callback_MouseEvent_Void {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} synthetic_Callback_MouseEvent_Void;
typedef struct Opt_synthetic_Callback_MouseEvent_Void {
    Ark_Tag tag;
    synthetic_Callback_MouseEvent_Void value;
} Opt_synthetic_Callback_MouseEvent_Void;
typedef struct synthetic_Callback_Number_Void {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} synthetic_Callback_Number_Void;
typedef struct Opt_synthetic_Callback_Number_Void {
    Ark_Tag tag;
    synthetic_Callback_Number_Void value;
} Opt_synthetic_Callback_Number_Void;
typedef struct synthetic_Callback_String_Void {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} synthetic_Callback_String_Void;
typedef struct Opt_synthetic_Callback_String_Void {
    Ark_Tag tag;
    synthetic_Callback_String_Void value;
} Opt_synthetic_Callback_String_Void;
typedef struct synthetic_Callback_TextPickerResult_Void {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} synthetic_Callback_TextPickerResult_Void;
typedef struct Opt_synthetic_Callback_TextPickerResult_Void {
    Ark_Tag tag;
    synthetic_Callback_TextPickerResult_Void value;
} Opt_synthetic_Callback_TextPickerResult_Void;
typedef struct synthetic_Callback_TouchEvent_Void {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} synthetic_Callback_TouchEvent_Void;
typedef struct Opt_synthetic_Callback_TouchEvent_Void {
    Ark_Tag tag;
    synthetic_Callback_TouchEvent_Void value;
} Opt_synthetic_Callback_TouchEvent_Void;
...
typedef struct Throws_Array_SpanStyle {
    /* kind: Interface */
...
} Throws_Array_SpanStyle;
typedef struct Opt_Throws_Array_SpanStyle {
    Ark_Tag tag;
    Throws_Array_SpanStyle value;
} Opt_Throws_Array_SpanStyle;
typedef struct Throws_Boolean {
    /* kind: Interface */
    Ark_Boolean hasException;
    union {
        Ark_Exception exception;
...
typedef struct Opt_Throws_Boolean {
    Ark_Tag tag;
    Throws_Boolean value;
} Opt_Throws_Boolean;
typedef struct Throws_Number {
    /* kind: Interface */
    Ark_Boolean hasException;
    union {
        Ark_Exception exception;
...
typedef struct Opt_Throws_Number {
    Ark_Tag tag;
    Throws_Number value;
} Opt_Throws_Number;
typedef struct Throws_RectResult {
    /* kind: Interface */
    Ark_Boolean hasException;
    union {
        Ark_Exception exception;
...
typedef struct Opt_Throws_RectResult {
    Ark_Tag tag;
    Throws_RectResult value;
} Opt_Throws_RectResult;
typedef struct Throws_String {
    /* kind: Interface */
    Ark_Boolean hasException;
    union {
        Ark_Exception exception;
...
typedef struct Opt_Throws_String {
    Ark_Tag tag;
    Throws_String value;
} Opt_Throws_String;
typedef struct Throws_StyledString {
    /* kind: Interface */
    Ark_Boolean hasException;
    union {
        Ark_Exception exception;
...
typedef struct Opt_Throws_StyledString {
    Ark_Tag tag;
    Throws_StyledString value;
} Opt_Throws_StyledString;
typedef struct Throws_UnifiedData {
    /* kind: Interface */
    Ark_Boolean hasException;
    union {
        Ark_Exception exception;
...
typedef struct Opt_Throws_UnifiedData {
    Ark_Tag tag;
    Throws_UnifiedData value;
} Opt_Throws_UnifiedData;
...
typedef struct Ark_arkui_component_TranslateOptions {
    /* kind: Interface */
    Opt_Union_Number_String x;
    Opt_Union_Number_String y;
    Opt_Union_Number_String z;
} Ark_arkui_component_TranslateOptions;
typedef struct Opt_arkui_component_TranslateOptions {
    Ark_Tag tag;
    Ark_arkui_component_TranslateOptions value;
} Opt_arkui_component_TranslateOptions;
...
typedef struct Ark_DrawingColorFilter {
    /* kind: Interface */
    Ark_String value;
} Ark_DrawingColorFilter;
...
typedef struct Ark_EllipseShape {
    /* kind: Interface */
    Ark_String value;
} Ark_EllipseShape;
...
typedef struct Ark_SelectionMenuOptions {
    ...
    Opt_Callback_Void_Void onDisappear;
...
typedef struct Ark_TransitionEffects {
    ...
    Ark_arkui_component_TranslateOptions translate;
...
typedef struct Ark_Union_Number_String_Array_Object {
    /* kind: UnionType */
    Ark_Int32 selector;
    union {
        Ark_Number value0;
...
} Ark_Union_Number_String_Array_Object;
typedef struct Opt_Union_Number_String_Array_Object {
    Ark_Tag tag;
    Ark_Union_Number_String_Array_Object value;
} Opt_Union_Number_String_Array_Object;
...
typedef struct Ark_Union_String_Number_Resource_Array_Dimension {
    /* kind: UnionType */
    Ark_Int32 selector;
    union {
        Ark_String value0;
        Ark_Number value1;
        Ark_Resource value2;
        Array_Dimension value3;
    };
} Ark_Union_String_Number_Resource_Array_Dimension;
typedef struct Opt_Union_String_Number_Resource_Array_Dimension {
    Ark_Tag tag;
    Ark_Union_String_Number_Resource_Array_Dimension value;
} Opt_Union_String_Number_Resource_Array_Dimension;
...
typedef struct Throws_VisibleListContentInfo {
    /* kind: Interface */
    Ark_Boolean hasException;
    union {
        Ark_Exception exception;
...
} Throws_VisibleListContentInfo;
typedef struct Opt_Throws_VisibleListContentInfo {
    Ark_Tag tag;
    Throws_VisibleListContentInfo value;
} Opt_Throws_VisibleListContentInfo;
...
typedef struct Ark_NavigationAnimatedTransition {
    /* kind: Interface */
    Opt_synthetic_Callback_Boolean_Void onTransitionEnd;
    Opt_Number timeout;
...
typedef struct Ark_TransitionOptions {
    ...
    Opt_Number opacity;
    Opt_arkui_component_TranslateOptions translate;
...
typedef struct Ark_arkui_component_Edges {
    /* kind: Interface */
    Opt_Dimension top;
    Opt_Dimension left;
    Opt_Dimension bottom;
    Opt_Dimension right;
} Ark_arkui_component_Edges;
typedef struct Opt_arkui_component_Edges {
    Ark_Tag tag;
    Ark_arkui_component_Edges value;
} Opt_arkui_component_Edges;
typedef struct Ark_arkui_component_IndicatorStyle {
    /* kind: Interface */
    Opt_Length left;
    Opt_Length top;
    Opt_Length right;
    ...
    Opt_ResourceColor color;
    Opt_ResourceColor selectedColor;
} Ark_arkui_component_IndicatorStyle;
typedef struct Opt_arkui_component_IndicatorStyle {
    Ark_Tag tag;
    Ark_arkui_component_IndicatorStyle value;
} Opt_arkui_component_IndicatorStyle;
...
typedef struct Ark_ScrollSnapOptions {
    ...
    Opt_Union_String_Number_Resource_Array_Dimension snapPagination;
...
typedef struct Ark_TextDataDetectorConfig {
    ...
    Opt_synthetic_Callback_String_Void onDetectResultUpdate;
    Opt_ResourceColor color;
    Opt_DecorationStyleInterface decoration;
...
typedef struct Ark_Union_Dimension_Padding {
    /* kind: UnionType */
    Ark_Int32 selector;
    union {
        Ark_Dimension value0;
...
} Ark_Union_Dimension_Padding;
typedef struct Opt_Union_Dimension_Padding {
    Ark_Tag tag;
    Ark_Union_Dimension_Padding value;
} Opt_Union_Dimension_Padding;
...
typedef struct Ark_Union_EdgeOutlineWidths_String_Number_Resource {
    /* kind: UnionType */
    Ark_Int32 selector;
    union {
        Ark_EdgeOutlineWidths value0;
...
} Ark_Union_EdgeOutlineWidths_String_Number_Resource;
typedef struct Opt_Union_EdgeOutlineWidths_String_Number_Resource {
    Ark_Tag tag;
    Ark_Union_EdgeOutlineWidths_String_Number_Resource value;
} Opt_Union_EdgeOutlineWidths_String_Number_Resource;
...
typedef struct Ark_Union_OutlineRadiuses_String_Number_Resource {
    /* kind: UnionType */
    Ark_Int32 selector;
    union {
        Ark_OutlineRadiuses value0;
...
} Ark_Union_OutlineRadiuses_String_Number_Resource;
typedef struct Opt_Union_OutlineRadiuses_String_Number_Resource {
    Ark_Tag tag;
    Ark_Union_OutlineRadiuses_String_Number_Resource value;
} Opt_Union_OutlineRadiuses_String_Number_Resource;
...
typedef struct Ark_Union_Padding_LocalizedPadding {
    /* kind: UnionType */
    Ark_Int32 selector;
    union {
        Ark_Padding value0;
...
} Ark_Union_Padding_LocalizedPadding;
typedef struct Opt_Union_Padding_LocalizedPadding {
    Ark_Tag tag;
    Ark_Union_Padding_LocalizedPadding value;
} Opt_Union_Padding_LocalizedPadding;
...
typedef struct Ark_Union_Position_arkui_component_Edges_LocalizedEdges {
    /* kind: UnionType */
    Ark_Int32 selector;
    union {
        Ark_Position value0;
        Ark_arkui_component_Edges value1;
        Ark_LocalizedEdges value2;
    };
} Ark_Union_Position_arkui_component_Edges_LocalizedEdges;
typedef struct Opt_Union_Position_arkui_component_Edges_LocalizedEdges {
    Ark_Tag tag;
    Ark_Union_Position_arkui_component_Edges_LocalizedEdges value;
} Opt_Union_Position_arkui_component_Edges_LocalizedEdges;
...
typedef struct Ark_Union_String_CustomBuilder_NavDestinationCommonTitle_NavDestinationCustomTitle {
    /* kind: UnionType */
    Ark_Int32 selector;
    union {
        Ark_String value0;
...
} Ark_Union_String_CustomBuilder_NavDestinationCommonTitle_NavDestinationCustomTitle;
...
typedef struct Ark_Union_String_Number_Resource_BorderRadiuses {
    /* kind: UnionType */
    Ark_Int32 selector;
    union {
        Ark_String value0;
        Ark_Number value1;
        Ark_Resource value2;
        Ark_BorderRadiuses value3;
    };
} Ark_Union_String_Number_Resource_BorderRadiuses;
typedef struct Opt_Union_String_Number_Resource_BorderRadiuses {
    Ark_Tag tag;
    Ark_Union_String_Number_Resource_BorderRadiuses value;
} Opt_Union_String_Number_Resource_BorderRadiuses;
typedef struct Ark_Union_String_Number_Resource_BorderRadiuses_LocalizedBorderRadiuses {
    /* kind: UnionType */
    Ark_Int32 selector;
    union {
        Ark_String value0;
        ...
        Ark_Resource value2;
        Ark_BorderRadiuses value3;
        Ark_LocalizedBorderRadiuses value4;
    };
} Ark_Union_String_Number_Resource_BorderRadiuses_LocalizedBorderRadiuses;
typedef struct Opt_Union_String_Number_Resource_BorderRadiuses_LocalizedBorderRadiuses {
    Ark_Tag tag;
    Ark_Union_String_Number_Resource_BorderRadiuses_LocalizedBorderRadiuses value;
} Opt_Union_String_Number_Resource_BorderRadiuses_LocalizedBorderRadiuses;
typedef struct Ark_Union_String_Number_Resource_EdgeWidths_LocalizedEdgeWidths {
    /* kind: UnionType */
    Ark_Int32 selector;
    union {
        Ark_String value0;
        Ark_Number value1;
        Ark_Resource value2;
        Ark_EdgeWidths value3;
        Ark_LocalizedEdgeWidths value4;
    };
} Ark_Union_String_Number_Resource_EdgeWidths_LocalizedEdgeWidths;
typedef struct Opt_Union_String_Number_Resource_EdgeWidths_LocalizedEdgeWidths {
    Ark_Tag tag;
    Ark_Union_String_Number_Resource_EdgeWidths_LocalizedEdgeWidths value;
} Opt_Union_String_Number_Resource_EdgeWidths_LocalizedEdgeWidths;
typedef struct Ark_Union_String_Number_Resource_LeadingMarginPlaceholder {
    /* kind: UnionType */
    Ark_Int32 selector;
    union {
        Ark_String value0;
        Ark_Number value1;
        Ark_Resource value2;
        Ark_LeadingMarginPlaceholder value3;
    };
} Ark_Union_String_Number_Resource_LeadingMarginPlaceholder;
typedef struct Opt_Union_String_Number_Resource_LeadingMarginPlaceholder {
    Ark_Tag tag;
    Ark_Union_String_Number_Resource_LeadingMarginPlaceholder value;
} Opt_Union_String_Number_Resource_LeadingMarginPlaceholder;
typedef struct Ark_Union_String_Number_Resource_Padding {
    /* kind: UnionType */
    Ark_Int32 selector;
    union {
        Ark_String value0;
...
} Ark_Union_String_Number_Resource_Padding;
typedef struct Opt_Union_String_Number_Resource_Padding {
    Ark_Tag tag;
    Ark_Union_String_Number_Resource_Padding value;
} Opt_Union_String_Number_Resource_Padding;
typedef struct Ark_AlertDialogParamWithButtons {
    ...
    Opt_TransitionEffect transition;
    Opt_Union_String_Number_Resource_BorderRadiuses_LocalizedBorderRadiuses cornerRadius;
    Opt_Dimension width;
    Opt_Dimension height;
    Opt_Union_String_Number_Resource_EdgeWidths_LocalizedEdgeWidths borderWidth;
...
typedef struct Ark_ImageAttachmentLayoutStyle {
    /* kind: Interface */
    Opt_Union_LengthMetrics_Padding margin;
...
typedef struct Ark_OutlineOptions {
    /* kind: Interface */
    Opt_Union_EdgeOutlineWidths_String_Number_Resource width;
    Opt_Union_EdgeColors_ResourceColor_LocalizedEdgeColors color;
    Opt_Union_OutlineRadiuses_String_Number_Resource radius;
...
typedef struct Ark_RichEditorLayoutStyle {
    /* kind: Interface */
    Opt_Union_String_Number_Resource_Padding margin;
    Opt_Union_String_Number_Resource_BorderRadiuses borderRadius;
...
typedef struct Ark_RichEditorParagraphStyle {
    /* kind: Interface */
    Opt_TextAlign textAlign;
    Opt_Union_String_Number_Resource_LeadingMarginPlaceholder leadingMargin;
    Opt_WordBreak wordBreak;
...
typedef struct Ark_SwipeActionOptions {
    ...
    Opt_synthetic_Callback_Number_Void onOffsetChange;
...
typedef struct Ark_TextBackgroundStyle {
    /* kind: Interface */
    Opt_ResourceColor color;
    Opt_Union_String_Number_Resource_BorderRadiuses radius;
...
typedef struct Ark_TextPickerDialogOptions {
    ...
    Opt_synthetic_Callback_TextPickerResult_Void onAccept;
    Opt_Callback_Void onCancel;
    Opt_synthetic_Callback_TextPickerResult_Void onChange;
...
typedef struct GENERATED_ArkUICommonMethodModifier {
    ...
    void (*setWidth)(Ark_NativePointer node,
                     const Ark_Union_Length_LayoutPolicy* value);
    ...
    void (*setOnChildTouchTest)(Ark_NativePointer node,
                                const Callback_Array_TouchTestInfo_TouchResult* event);
    void (*setLayoutWeight)(Ark_NativePointer node,
                            const Ark_Union_Number_String* value);
    void (*setChainWeight)(Ark_NativePointer node,
                           const Ark_ChainWeightOptions* chainWeight);
    ...
    void (*setSafeAreaPadding)(Ark_NativePointer node,
                               const Ark_Union_Padding_LengthMetrics_LocalizedPadding* paddingValue);
    ...
    void (*setVisualEffect)(Ark_NativePointer node,
                            const Ark_VisualEffect* effect);
    void (*setBackgroundFilter)(Ark_NativePointer node,
                                const Ark_Filter* filter);
    ...
    void (*setTranslate)(Ark_NativePointer node,
                         const Ark_arkui_component_TranslateOptions* value);
    ...
    void (*setPosition)(Ark_NativePointer node,
                        const Ark_Union_Position_arkui_component_Edges_LocalizedEdges* value);
    ...
    void (*setOnDragStart)(Ark_NativePointer node,
                           const Type_CommonMethod_onDragStart_event* event);
    void (*setOnDragEnter)(Ark_NativePointer node,
                           const Callback_DragEvent_Opt_String_Void* event);
    ...
    void (*setOnPreDrag)(Ark_NativePointer node,
                         const Callback_PreDragStatus_Void* callback_);
    ...
    void (*setOnGestureJudgeBegin)(Ark_NativePointer node,
                                   const Callback_GestureInfo_BaseGestureEvent_GestureJudgeResult* callback_);
...
typedef struct GENERATED_ArkUIEmbeddedComponentModifier {
    ...
    void (*setOnTerminated)(Ark_NativePointer node,
                            const Callback_TerminationInfo_Void* callback_);
...
typedef struct GENERATED_ArkUIFormComponentModifier {
    ...
    void (*setOnAcquired)(Ark_NativePointer node,
                          const Callback_FormCallbackInfo_Void* callback_);
...
typedef struct GENERATED_ArkUIGridItemModifier {
    ...
    void (*setOnSelect)(Ark_NativePointer node,
                        const synthetic_Callback_Boolean_Void* event);
    void (*set_onChangeEvent_selected)(Ark_NativePointer node,
                                       const synthetic_Callback_Number_Void* callback_);
...
typedef struct GENERATED_ArkUIImageModifier {
    ...
    void (*setOnComplete)(Ark_NativePointer node,
                          const Type_ImageAttribute_onComplete_callback* callback_);
    void (*setOnError)(Ark_NativePointer node,
                       const ImageErrorCallback* callback_);
    ...
    void (*setEnhancedImageQuality)(Ark_NativePointer node,
                                    const Ark_ResolutionQuality* imageQuality);
    void (*setOrientation)(Ark_NativePointer node,
                           Ark_ImageRotateOrientation orientation);
...
typedef struct GENERATED_ArkUIIndicatorComponentModifier {
    ...
    void (*setStyle)(Ark_NativePointer node,
                     const Ark_Union_DotIndicator_DigitIndicator* indicatorStyle);
    void (*setLoop)(Ark_NativePointer node,
                    Ark_Boolean isLoop);
    void (*setVertical)(Ark_NativePointer node,
                        Ark_Boolean isVertical);
    void (*setOnChange)(Ark_NativePointer node,
                        const Callback_Number_Void* event);
...
typedef struct GENERATED_ArkUIListModifier {
    ...
    void (*setOnScroll)(Ark_NativePointer node,
                        const Callback_Number_ScrollState_Void* event);
    void (*setOnScrollIndex)(Ark_NativePointer node,
                             const Callback_Number_Number_Number_Void* event);
    void (*setOnScrollVisibleContentChange)(Ark_NativePointer node,
                                            const OnScrollVisibleContentChangeCallback* handler);
    ...
    void (*setOnItemDelete)(Ark_NativePointer node,
                            const Callback_Number_Boolean* event);
    void (*setOnItemMove)(Ark_NativePointer node,
                          const Callback_Number_Number_Boolean* event);
    void (*setOnItemDragStart)(Ark_NativePointer node,
                               const Callback_ItemDragInfo_Number_Callback_Any* event);
    void (*setOnItemDragEnter)(Ark_NativePointer node,
                               const Callback_ItemDragInfo_Void* event);
    void (*setOnItemDragMove)(Ark_NativePointer node,
                              const Callback_ItemDragInfo_Number_Number_Void* event);
    void (*setOnItemDragLeave)(Ark_NativePointer node,
                               const Callback_ItemDragInfo_Number_Void* event);
    void (*setOnItemDrop)(Ark_NativePointer node,
                          const Callback_ItemDragInfo_Number_Number_Boolean_Void* event);
    void (*setOnScrollFrameBegin)(Ark_NativePointer node,
                                  const Callback_Number_ScrollState_Literal_Number_offsetRemain* event);
...
typedef struct GENERATED_ArkUINavDestinationModifier {
    ...
    void (*setTitle)(Ark_NativePointer node,
                     const Ark_Union_String_CustomBuilder_NavDestinationCommonTitle_NavDestinationCustomTitle* value,
    ...
    void (*setOnBackPressed)(Ark_NativePointer node,
                             const Callback_Boolean* callback_);
    ...
    void (*setOnReady)(Ark_NativePointer node,
                       const Callback_NavDestinationContext_Void* callback_);
    ...
    void (*setSystemBarStyle)(Ark_NativePointer node,
                              const Opt_SystemBarStyle* style);
...
typedef struct GENERATED_ArkUINavigationModifier {
    ...
    void (*setHideNavBar)(Ark_NativePointer node,
                          Ark_Boolean value);
    void (*setTitle)(Ark_NativePointer node,
                     const Ark_Union_ResourceStr_CustomBuilder_NavigationCommonTitle_NavigationCustomTitle* value,
                     const Opt_NavigationTitleOptions* options);
    ...
    void (*setOnNavBarStateChange)(Ark_NativePointer node,
                                   const synthetic_Callback_Boolean_Void* callback_);
    void (*setOnNavigationModeChange)(Ark_NativePointer node,
                                      const Callback_NavigationMode_Void* callback_);
    void (*setNavDestination)(Ark_NativePointer node,
                              const Callback_String_Unknown_Void* builder);
    void (*setCustomNavContentTransition)(Ark_NativePointer node,
                                          const Type_NavigationAttribute_customNavContentTransition_delegate* delegate);
    void (*setIgnoreLayoutSafeArea)(Ark_NativePointer node,
                                    const Opt_Array_LayoutSafeAreaType* types,
                                    const Opt_Array_LayoutSafeAreaEdge* edges);
    void (*setSystemBarStyle)(Ark_NativePointer node,
...
typedef struct GENERATED_ArkUIRectModifier {
    ...
    void (*setRadius)(Ark_NativePointer node,
                      const Ark_Union_Number_String_Array_Object* value);
...
typedef struct GENERATED_ArkUIRichEditorModifier {
    ...
    void (*setOnReady)(Ark_NativePointer node,
                       const Callback_Void_Void* callback_);
    void (*setOnSelect)(Ark_NativePointer node,
                        const Callback_RichEditorSelection_Void* callback_);
    void (*setOnSelectionChange)(Ark_NativePointer node,
                                 const Callback_RichEditorRange_Void* callback_);
    void (*setAboutToIMEInput)(Ark_NativePointer node,
                               const Callback_RichEditorInsertValue_Boolean* callback_);
    void (*setOnIMEInputComplete)(Ark_NativePointer node,
                                  const Callback_RichEditorTextSpanResult_Void* callback_);
    void (*setOnDidIMEInput)(Ark_NativePointer node,
                             const Callback_TextRange_Void* callback_);
    void (*setAboutToDelete)(Ark_NativePointer node,
                             const Callback_RichEditorDeleteValue_Boolean* callback_);
    ...
    void (*setOnPaste)(Ark_NativePointer node,
                       const PasteEventCallback* callback_);
    ...
    void (*setOnSubmit)(Ark_NativePointer node,
                        const SubmitCallback* callback_);
    void (*setOnWillChange)(Ark_NativePointer node,
                            const Callback_RichEditorChangeValue_Boolean* callback_);
    void (*setOnDidChange)(Ark_NativePointer node,
                           const OnDidChangeCallback* callback_);
    void (*setOnCut)(Ark_NativePointer node,
                     const Callback_CutEvent_Void* callback_);
    void (*setOnCopy)(Ark_NativePointer node,
                      const Callback_CopyEvent_Void* callback_);
    void (*setEditMenuOptions)(Ark_NativePointer node,
                               const Ark_EditMenuOptions* editMenu);
...
typedef struct GENERATED_ArkUIScrollModifier {
    ...
    void (*setOnWillScroll)(Ark_NativePointer node,
                            const ScrollOnWillScrollCallback* handler);
    ...
    void (*setOnScrollEdge)(Ark_NativePointer node,
                            const OnScrollEdgeCallback* event);
    void (*setOnScrollStart)(Ark_NativePointer node,
                             const VoidCallback* event);
    ...
    void (*setEdgeEffect)(Ark_NativePointer node,
                          ...
                          const Opt_EdgeEffectOptions* options);
    void (*setOnScrollFrameBegin)(Ark_NativePointer node,
                                  const OnScrollFrameBeginCallback* event);
    void (*setNestedScroll)(Ark_NativePointer node,
                            const Ark_NestedScrollOptions* value);
    void (*setEnableScrollInteraction)(Ark_NativePointer node,
                                       Ark_Boolean value);
...
typedef struct GENERATED_ArkUIScrollableCommonMethodModifier {
    ...
    void (*setClipContent)(Ark_NativePointer node,
                           const Ark_Union_ContentClipMode_RectShape* clip);
...
typedef struct GENERATED_ArkUISearchModifier {
    ...
    void (*setEnterKeyType)(Ark_NativePointer node,
                            Ark_EnterKeyType value);
    void (*setOnSubmit)(Ark_NativePointer node,
                        const SearchSubmitCallback* callback_);
    void (*setOnChange)(Ark_NativePointer node,
                        const EditableTextOnChangeCallback* callback_);
    void (*setOnTextSelectionChange)(Ark_NativePointer node,
                                     const OnTextSelectionChangeCallback* callback_);
    void (*setOnContentScroll)(Ark_NativePointer node,
                               const OnContentScrollCallback* callback_);
    void (*setOnCopy)(Ark_NativePointer node,
                      const Callback_String_Void* callback_);
    void (*setOnCut)(Ark_NativePointer node,
                     const Callback_String_Void* callback_);
    void (*setOnPaste)(Ark_NativePointer node,
                       const OnPasteCallback* callback_);
    void (*setCopyOption)(Ark_NativePointer node,
                          Ark_CopyOptions value);
    ...
    void (*setOnWillInsert)(Ark_NativePointer node,
                            const Callback_InsertValue_Boolean* callback_);
    void (*setOnDidInsert)(Ark_NativePointer node,
                           const Callback_InsertValue_Void* callback_);
    void (*setOnWillDelete)(Ark_NativePointer node,
                            const Callback_DeleteValue_Boolean* callback_);
    void (*setOnDidDelete)(Ark_NativePointer node,
                           const Callback_DeleteValue_Void* callback_);
    void (*setEditMenuOptions)(Ark_NativePointer node,
                               const Ark_EditMenuOptions* editMenu);
    void (*setEnablePreviewText)(Ark_NativePointer node,
                                 Ark_Boolean enable);
    ...
    void (*set_onChangeEvent_value)(Ark_NativePointer node,
                                    const synthetic_Callback_String_Void* callback_);
...
typedef struct GENERATED_ArkUISwiperModifier {
    ...
    void (*setIndicator1)(Ark_NativePointer node,
                          Ark_IndicatorComponentController controller);
    ...
    void (*setIndicatorStyle)(Ark_NativePointer node,
                              const Opt_arkui_component_IndicatorStyle* value);
    ...
    void (*setOnAnimationStart)(Ark_NativePointer node,
                                const OnSwiperAnimationStartCallback* event);
    void (*setOnAnimationEnd)(Ark_NativePointer node,
                              const OnSwiperAnimationEndCallback* event);
    void (*setOnGestureSwipe)(Ark_NativePointer node,
                              const OnSwiperGestureSwipeCallback* event);
    void (*setNestedScroll)(Ark_NativePointer node,
                            Ark_SwiperNestedScrollMode value);
    ...
    void (*setOnContentDidScroll)(Ark_NativePointer node,
                                  const ContentDidScrollCallback* handler);
...
typedef struct GENERATED_ArkUITest1Modifier {
    ...
    void (*setTestUnionWithGenericArray)(Ark_NativePointer node,
                                         const Ark_Union_Number_Array_String* value);
    ...
    void (*setTestTupleBooleanNumber)(Ark_NativePointer node,
                                      const Ark_Tuple_Boolean_Number* value);
    void (*setTestTupleNumberStringEnum)(Ark_NativePointer node,
                                         const Ark_Tuple_Number_String_EnumDTS* value);
    void (*setTestTupleOptional)(Ark_NativePointer node,
                                 const Ark_Tuple_Number_String_Boolean_EnumDTS* value);
    void (*setTestTupleUnion)(Ark_NativePointer node,
                              const Ark_Type_Test1Attribute_testTupleUnion_value* value);
    ...
    void (*setTestOptionInterface)(Ark_NativePointer node,
                                   const Ark_OptionInterfaceDTS* value);
...
typedef struct GENERATED_ArkUITextInputModifier {
    ...
    void (*setOnEditChange)(Ark_NativePointer node,
                            const Callback_Boolean_Void* callback_);
    void (*setOnSubmit)(Ark_NativePointer node,
                        const OnSubmitCallback* callback_);
    void (*setOnChange)(Ark_NativePointer node,
                        const EditableTextOnChangeCallback* callback_);
    void (*setOnTextSelectionChange)(Ark_NativePointer node,
                                     const OnTextSelectionChangeCallback* callback_);
    ...
    void (*setCancelButton0)(Ark_NativePointer node,
                             const Ark_CancelButtonOptions* options);
    void (*setCancelButton1)(Ark_NativePointer node,
                             const Ark_CancelButtonSymbolOptions* symbolOptions);
    ...
    void (*set_onChangeEvent_text)(Ark_NativePointer node,
                                   const Callback_ResourceStr_Void* callback_);
...
typedef struct GENERATED_ArkUITextPickerModifier {
    ...
    void (*set_onChangeEvent_value)(Ark_NativePointer node,
                                    const Callback_Union_String_Array_String_Void* callback_);
...
typedef struct GENERATED_ArkUIWebModifier {
    ...
    void (*setOnNativeEmbedLifecycleChange)(Ark_NativePointer node,
                                            const Callback_NativeEmbedDataInfo_Void* callback_);
    void (*setOnRenderExited0)(Ark_NativePointer node,
                               const Callback_OnRenderExitedEvent_Void* callback_);
    void (*setOnRenderExited1)(Ark_NativePointer node,
                               const Callback_Opt_Literal_Object_detail_Boolean* callback_);
    void (*setOnHttpErrorReceive)(Ark_NativePointer node,
                                  const Callback_OnHttpErrorReceiveEvent_Void* callback_);
...
typedef struct GENERATED_ArkUIAccessibilityHoverEventAccessor {
    ...
    void (*callHolder)(Ark_AccessibilityHoverEvent peer);
...
typedef struct GENERATED_ArkUIAlertDialogAccessor {
    void (*show)(const Ark_Union_AlertDialogParamWithConfirm_AlertDialogParamWithButtons_AlertDialogParamWithOptions* value);
...
typedef struct GENERATED_ArkUIAppearSymbolEffectAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_AppearSymbolEffect peer);
...
typedef struct GENERATED_ArkUIBackgroundColorStyleAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_BackgroundColorStyle peer);
...
typedef struct GENERATED_ArkUIBaseEventAccessor {
    ...
    Throws_Boolean (*getModifierKeyState)(Ark_BaseEvent peer,
...
typedef struct GENERATED_ArkUIBaseGestureEventAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_BaseGestureEvent peer);
...
typedef struct GENERATED_ArkUIBaselineOffsetStyleAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_BaselineOffsetStyle peer);
...
typedef struct GENERATED_ArkUIBottomTabBarStyleAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_BottomTabBarStyle peer);
    ...
    Ark_BottomTabBarStyle (*padding)(Ark_BottomTabBarStyle peer,
                                     const Ark_Union_Padding_LocalizedPadding* value);
...
typedef struct GENERATED_ArkUIBounceSymbolEffectAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_BounceSymbolEffect peer);
...
typedef struct GENERATED_ArkUICanvasGradientAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_CanvasGradient peer);
...
typedef struct GENERATED_ArkUICanvasPathAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_CanvasPath peer);
...
typedef struct GENERATED_ArkUICanvasPatternAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_CanvasPattern peer);
...
typedef struct GENERATED_ArkUICanvasRendererAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_CanvasRenderer peer);
...
typedef struct GENERATED_ArkUICanvasRenderingContext2DAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_CanvasRenderingContext2D peer);
...
typedef struct GENERATED_ArkUIChildrenMainSizeAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_ChildrenMainSize peer);
    Throws_void (*splice)(Ark_ChildrenMainSize peer,
                          const Ark_Number* start,
                          const Opt_Number* deleteCount,
                          const Opt_Array_Number* childrenSize);
    Throws_void (*update)(Ark_ChildrenMainSize peer,
                          const Ark_Number* index,
...
typedef struct GENERATED_ArkUIClassWithConstructorAndAllOptionalParamsDTSAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_ClassWithConstructorAndAllOptionalParamsDTS peer);
...
typedef struct GENERATED_ArkUIClassWithConstructorAndFieldsAndMethodsDTSAccessor {
    ...
    Ark_ClassWithConstructorAndFieldsAndMethodsDTS (*construct)(const Ark_Number* valNumber,
                                                                Ark_Boolean valBoolean);
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_ClassWithConstructorAndFieldsAndMethodsDTS peer);
...
typedef struct GENERATED_ArkUIClassWithConstructorAndFieldsDTSAccessor {
    ...
    Ark_ClassWithConstructorAndFieldsDTS (*construct)(const Ark_Number* valNumber,
                                                      Ark_Boolean valBoolean);
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_ClassWithConstructorAndFieldsDTS peer);
...
typedef struct GENERATED_ArkUIClassWithConstructorAndMethodsDTSAccessor {
    ...
    Ark_ClassWithConstructorAndMethodsDTS (*construct)(const Ark_Number* valNumber,
                                                       const Ark_String* valString);
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_ClassWithConstructorAndMethodsDTS peer);
...
typedef struct GENERATED_ArkUIClassWithConstructorAndNonOptionalParamsDTSAccessor {
    ...
    Ark_ClassWithConstructorAndNonOptionalParamsDTS (*construct)(const Ark_Number* valNumber,
                                                                 const Ark_String* valString);
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_ClassWithConstructorAndNonOptionalParamsDTS peer);
...
typedef struct GENERATED_ArkUIClassWithConstructorAndSomeOptionalParamsDTSAccessor {
    ...
    Ark_ClassWithConstructorAndSomeOptionalParamsDTS (*construct)(const Ark_Number* valNumber,
                                                                  const Opt_String* valString);
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_ClassWithConstructorAndSomeOptionalParamsDTS peer);
...
typedef struct GENERATED_ArkUIClassWithConstructorAndStaticMethodsDTSAccessor {
    ...
    Ark_ClassWithConstructorAndStaticMethodsDTS (*construct)(const Ark_Number* valNumber,
                                                             const Ark_String* valString);
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_ClassWithConstructorAndStaticMethodsDTS peer);
...
typedef struct GENERATED_ArkUIClassWithConstructorAndWithoutParamsDTSAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_ClassWithConstructorAndWithoutParamsDTS peer);
...
typedef struct GENERATED_ArkUIClassWithConstructorDTSAccessor {
    ...
    Ark_ClassWithConstructorDTS (*construct)(const Ark_Number* valNumber,
                                             const Ark_String* valString);
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_ClassWithConstructorDTS peer);
...
typedef struct GENERATED_ArkUIColorFilterAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_ColorFilter peer);
...
typedef struct GENERATED_ArkUIContextAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_Context peer);
...
typedef struct GENERATED_ArkUICustomDialogControllerAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_CustomDialogController peer);
...
typedef struct GENERATED_ArkUICustomSpanAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_CustomSpan peer);
...
typedef struct GENERATED_ArkUIDecorationStyleAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_DecorationStyle peer);
...
typedef struct GENERATED_ArkUIDigitIndicatorAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_DigitIndicator peer);
...
typedef struct GENERATED_ArkUIDisappearSymbolEffectAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_DisappearSymbolEffect peer);
...
typedef struct GENERATED_ArkUIDotIndicatorAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_DotIndicator peer);
...
typedef struct GENERATED_ArkUIDragEventAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_DragEvent peer);
    ...
    Throws_UnifiedData (*getData)(Ark_DragEvent peer);
    Ark_Summary (*getSummary)(Ark_DragEvent peer);
    ...
    Throws_Boolean (*getModifierKeyState)(Ark_DragEvent peer,
                                          const Array_String* keys);
...
typedef struct GENERATED_ArkUIDrawingRenderingContextAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_DrawingRenderingContext peer);
...
typedef struct GENERATED_ArkUIDrawModifierAccessor {
    ...
    Opt_Callback_DrawContext_Void (*getDrawBehind)(Ark_DrawModifier peer);
    void (*setDrawBehind)(Ark_DrawModifier peer,
                          const Opt_Callback_DrawContext_Void* drawBehind);
    Opt_Callback_DrawContext_Void (*getDrawContent)(Ark_DrawModifier peer);
    void (*setDrawContent)(Ark_DrawModifier peer,
                           const Opt_Callback_DrawContext_Void* drawContent);
    Opt_Callback_DrawContext_Void (*getDrawFront)(Ark_DrawModifier peer);
...
typedef struct GENERATED_ArkUIEventTargetInfoAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_EventTargetInfo peer);
...
typedef struct GENERATED_ArkUIGestureEventAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_GestureEvent peer);
...
typedef struct GENERATED_ArkUIGestureRecognizerAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_GestureRecognizer peer);
...
typedef struct GENERATED_ArkUIGestureStyleAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_GestureStyle peer);
...
typedef struct GENERATED_ArkUIHierarchicalSymbolEffectAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_HierarchicalSymbolEffect peer);
...
typedef struct GENERATED_ArkUIHoverEventAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_HoverEvent peer);
...
typedef struct GENERATED_ArkUIICurveAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_ICurve peer);
...
typedef struct GENERATED_ArkUIImageAnalyzerControllerAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_ImageAnalyzerController peer);
...
typedef struct GENERATED_ArkUIImageAttachmentAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_ImageAttachment peer);
...
typedef struct GENERATED_ArkUIImageBitmapAccessor {
    ...
    Ark_ImageBitmap (*construct3)(Ark_PixelMap data,
                                  Ark_LengthMetricsUnit unit);
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_ImageBitmap peer);
...
typedef struct GENERATED_ArkUIIndicatorAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_Indicator peer);
...
typedef struct GENERATED_ArkUIIndicatorComponentControllerAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_IndicatorComponentController peer);
...
typedef struct GENERATED_ArkUIKeyEventAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_KeyEvent peer);
    Throws_Boolean (*getModifierKeyState)(Ark_KeyEvent peer,
                                          const Array_String* keys);
...
typedef struct GENERATED_ArkUILayoutableAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_Layoutable peer);
...
typedef struct GENERATED_ArkUILayoutManagerAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_LayoutManager peer);
    ...
    Ark_PositionWithAffinity (*getGlyphPositionAtCoordinate)(Ark_LayoutManager peer,
                                                             const Ark_Number* x,
                                                             const Ark_Number* y);
    Ark_LineMetrics (*getLineMetrics)(Ark_LayoutManager peer,
                                      const Ark_Number* lineNumber);
    Array_TextBox (*getRectsForRange)(Ark_LayoutManager peer,
                                      const Ark_TextRange* range,
                                      const Ark_RectWidthStyle* widthStyle,
                                      const Ark_RectHeightStyle* heightStyle);
...
typedef struct GENERATED_ArkUILetterSpacingStyleAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_LetterSpacingStyle peer);
...
typedef struct GENERATED_ArkUILinearGradientAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_LinearGradient peer);
...
typedef struct GENERATED_ArkUILineHeightStyleAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_LineHeightStyle peer);
...
typedef struct GENERATED_ArkUIListScrollerAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_ListScroller peer);
    Throws_RectResult (*getItemRectInGroup)(Ark_ListScroller peer,
                                            const Ark_Number* index,
                                            const Ark_Number* indexInGroup);
    Throws_void (*scrollToItemInGroup)(Ark_ListScroller peer,
                                       const Ark_Number* index,
                                       const Ark_Number* indexInGroup,
                                       const Opt_Boolean* smooth,
                                       const Opt_ScrollAlign* align);
    Throws_void (*closeAllSwipeActions)(Ark_ListScroller peer,
                                        const Opt_CloseSwipeActionOptions* options);
    Throws_VisibleListContentInfo (*getVisibleListContentInfo)(Ark_ListScroller peer,
                                                               const Ark_Number* x,
                                                               const Ark_Number* y);
...
typedef struct GENERATED_ArkUILongPressGestureEventAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_LongPressGestureEvent peer);
...
typedef struct GENERATED_ArkUIMatrix2DAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_Matrix2D peer);
...
typedef struct GENERATED_ArkUIMeasurableAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_Measurable peer);
...
typedef struct GENERATED_ArkUIMouseEventAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_MouseEvent peer);
...
typedef struct GENERATED_ArkUIMutableStyledStringAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_MutableStyledString peer);
    Throws_void (*replaceString)(Ark_MutableStyledString peer,
                                 const Ark_Number* start,
                                 const Ark_Number* length,
                                 const Ark_String* other);
    Throws_void (*insertString)(Ark_MutableStyledString peer,
                                const Ark_Number* start,
                                const Ark_String* other);
    Throws_void (*removeString)(Ark_MutableStyledString peer,
                                const Ark_Number* start,
                                const Ark_Number* length);
    Throws_void (*replaceStyle)(Ark_MutableStyledString peer,
                                const Ark_SpanStyle* spanStyle);
    Throws_void (*setStyle)(Ark_MutableStyledString peer,
                            const Ark_SpanStyle* spanStyle);
    Throws_void (*removeStyle)(Ark_MutableStyledString peer,
                               const Ark_Number* start,
                               const Ark_Number* length,
                               Ark_StyledStringKey styledKey);
    Throws_void (*removeStyles)(Ark_MutableStyledString peer,
                                const Ark_Number* start,
                                const Ark_Number* length);
    void (*clearStyles)(Ark_MutableStyledString peer);
    Throws_void (*replaceStyledString)(Ark_MutableStyledString peer,
                                       const Ark_Number* start,
                                       const Ark_Number* length,
                                       Ark_StyledString other);
    Throws_void (*insertStyledString)(Ark_MutableStyledString peer,
                                      const Ark_Number* start,
                                      Ark_StyledString other);
...
typedef struct GENERATED_ArkUINavDestinationContextAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_NavDestinationContext peer);
...
typedef struct GENERATED_ArkUINavigationTransitionProxyAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_NavigationTransitionProxy peer);
...
typedef struct GENERATED_ArkUINavPathInfoAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_NavPathInfo peer);
...
typedef struct GENERATED_ArkUINavPathStackAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_NavPathStack peer);
...
typedef struct GENERATED_ArkUIPanGestureEventAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_PanGestureEvent peer);
...
typedef struct GENERATED_ArkUIPanGestureOptionsAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_PanGestureOptions peer);
...
typedef struct GENERATED_ArkUIPanRecognizerAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_PanRecognizer peer);
...
typedef struct GENERATED_ArkUIParagraphStyleAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_ParagraphStyle peer);
...
typedef struct GENERATED_ArkUIPinchGestureEventAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_PinchGestureEvent peer);
...
typedef struct GENERATED_ArkUIPixelMapAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_PixelMap peer);
...
typedef struct GENERATED_ArkUIPixelMapMockAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_PixelMapMock peer);
...
typedef struct GENERATED_ArkUIProgressMaskAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_ProgressMask peer);
...
typedef struct GENERATED_ArkUIRenderingContextSettingsAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_RenderingContextSettings peer);
...
typedef struct GENERATED_ArkUIReplaceSymbolEffectAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_ReplaceSymbolEffect peer);
...
typedef struct GENERATED_ArkUIRichEditorBaseControllerAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_RichEditorBaseController peer);
...
typedef struct GENERATED_ArkUIRichEditorControllerAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_RichEditorController peer);
    ...
    Throws_StyledString (*toStyledString)(Ark_RichEditorController peer,
...
typedef struct GENERATED_ArkUIRichEditorStyledStringControllerAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_RichEditorStyledStringController peer);
...
typedef struct GENERATED_ArkUIRotationGestureEventAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_RotationGestureEvent peer);
...
typedef struct GENERATED_ArkUIScaleSymbolEffectAccessor {
    ...
    Ark_ScaleSymbolEffect (*construct)(const Opt_EffectScope* scope,
                                       const Opt_EffectDirection* direction);
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_ScaleSymbolEffect peer);
...
typedef struct GENERATED_ArkUIScrollableTargetInfoAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_ScrollableTargetInfo peer);
...
typedef struct GENERATED_ArkUIScrollerAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_Scroller peer);
    ...
    Throws_void (*fling)(Ark_Scroller peer,
                         const Ark_Number* velocity);
    ...
    Throws_RectResult (*getItemRect)(Ark_Scroller peer,
                                     const Ark_Number* index);
    Throws_Number (*getItemIndex)(Ark_Scroller peer,
                                  const Ark_Number* x,
                                  const Ark_Number* y);
...
typedef struct GENERATED_ArkUISearchControllerAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_SearchController peer);
...
typedef struct GENERATED_ArkUIStyledStringAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_StyledString peer);
    Ark_String (*getString)(Ark_StyledString peer);
    Throws_Array_SpanStyle (*getStyles)(Ark_StyledString peer,
                                        const Ark_Number* start,
                                        const Ark_Number* length,
                                        const Opt_StyledStringKey* styledKey);
    Ark_Boolean (*equals)(Ark_StyledString peer,
                          Ark_StyledString other);
    Throws_StyledString (*subStyledString)(Ark_StyledString peer,
                                           const Ark_Number* start,
    ...
    Throws_String (*toHtml)(Ark_StyledString styledString);
...
typedef struct GENERATED_ArkUIStyledStringControllerAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_StyledStringController peer);
...
typedef struct GENERATED_ArkUISubmitEventAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_SubmitEvent peer);
...
typedef struct GENERATED_ArkUISubTabBarStyleAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_SubTabBarStyle peer);
...
typedef struct GENERATED_ArkUISwipeGestureEventAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_SwipeGestureEvent peer);
...
typedef struct GENERATED_ArkUISwiperContentTransitionProxyAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_SwiperContentTransitionProxy peer);
...
typedef struct GENERATED_ArkUISwiperControllerAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_SwiperController peer);
...
typedef struct GENERATED_ArkUITabsControllerAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_TabsController peer);
...
typedef struct GENERATED_ArkUITapGestureEventAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_TapGestureEvent peer);
...
typedef struct GENERATED_ArkUITextBaseControllerAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_TextBaseController peer);
...
typedef struct GENERATED_ArkUITextContentControllerBaseAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_TextContentControllerBase peer);
...
typedef struct GENERATED_ArkUITextControllerAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_TextController peer);
...
typedef struct GENERATED_ArkUITextEditControllerExAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_TextEditControllerEx peer);
...
typedef struct GENERATED_ArkUITextInputControllerAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_TextInputController peer);
...
typedef struct GENERATED_ArkUITextMenuItemIdAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_TextMenuItemId peer);
...
typedef struct GENERATED_ArkUITextShadowStyleAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_TextShadowStyle peer);
...
typedef struct GENERATED_ArkUITextStyle_styled_stringAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_TextStyle_styled_string peer);
...
typedef struct GENERATED_ArkUITouchEventAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_TouchEvent peer);
...
typedef struct GENERATED_ArkUITransitionEffectAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_TransitionEffect peer);
    Ark_TransitionEffect (*translate)(const Ark_arkui_component_TranslateOptions* options);
...
typedef struct GENERATED_ArkUIUICommonEventAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_UICommonEvent peer);
    ...
    void (*setOnAppear)(Ark_UICommonEvent peer,
                        const Opt_Callback_Void_Void* callback_);
...
typedef struct GENERATED_ArkUIUIExtensionProxyAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_UIExtensionProxy peer);
...
typedef struct GENERATED_ArkUIUrlStyleAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_UrlStyle peer);
...
typedef struct GENERATED_ArkUIViewAccessor {
    ...
    Ark_View (*construct)();
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_View peer);
    Ark_Object (*create)(Ark_View peer,
                         const Ark_Object* value);
...
typedef struct GENERATED_ArkUIWebResourceResponseAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    void (*callHolder)(Ark_WebResourceResponse peer);
...
typedef struct GENERATED_ArkUIGlobalScopeAccessor {
    ...
    void (*cursorControl_setCursor)(const Ark_PointerStyle* value);
    Ark_Resource (*dollar_r)(const Ark_String* value,
                             const Array_Object* params);
    Ark_Resource (*dollar_rawfile)(const Ark_String* value);
