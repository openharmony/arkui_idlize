...
function checkButton() {
    ...
    checkResult("height", () => peer.setHeightAttribute(132),
        `setHeight({.tag=INTEROP_TAG_OBJECT, .value={.selector=0, .value0={.selector=1, .value1=132}}})`)
    ...
    checkResult("labelStyle", () => peer.setLabelStyleAttribute({ maxLines: 3 }),
        `setLabelStyle({.tag=INTEROP_TAG_OBJECT, .value={.overflow={.tag=INTEROP_TAG_UNDEFINED, .value={}}, .maxLines={.tag=INTEROP_TAG_OBJECT, .value=3}, .minFontSize={.tag=INTEROP_TAG_UNDEFINED, .value={}}, .maxFontSize={.tag=INTEROP_TAG_UNDEFINED, .value={}}, .heightAdaptivePolicy={.tag=INTEROP_TAG_UNDEFINED, .value={}}, .font={.tag=INTEROP_TAG_UNDEFINED, .value={}}}})`)
...
function checkCalendar() {
    ...
    checkResult("setCalendarOptions: hintRadius", () => peer.setCalendarPickerOptionsAttribute({ hintRadius: 79 }),
        `setCalendarPickerOptions({.tag=INTEROP_TAG_OBJECT, .value={.hintRadius={.tag=INTEROP_TAG_OBJECT, .value={.selector=0, .value0=79}}, .selected={.tag=INTEROP_TAG_UNDEFINED, .value={}}, .start={.tag=INTEROP_TAG_UNDEFINED, .value={}}, .end={.tag=INTEROP_TAG_UNDEFINED, .value={}}, .disabledDateRange={.tag=INTEROP_TAG_UNDEFINED, .value={}}}})`)
...
function checkFormComponent() {
    ...
    checkResult("size int", () => peer.setSizeAttribute({ width: 5, height: 6 }),
        `setSize({.tag=INTEROP_TAG_OBJECT, .value={.width={.tag=INTEROP_TAG_OBJECT, .value={.selector=1, .value1=5}}, .height={.tag=INTEROP_TAG_OBJECT, .value={.selector=1, .value1=6}}}})`)
    checkResult("size float", () => peer.setSizeAttribute({ width: 5.5, height: 6.789 }),
        `setSize({.tag=INTEROP_TAG_OBJECT, .value={.width={.tag=INTEROP_TAG_OBJECT, .value={.selector=1, .value1=5.5}}, .height={.tag=INTEROP_TAG_OBJECT, .value={.selector=1, .value1=6.789}}}})`)
    checkResult("size zero", () => peer.setSizeAttribute({ width: 0.0, height: 0.0 }),
        `setSize({.tag=INTEROP_TAG_OBJECT, .value={.width={.tag=INTEROP_TAG_OBJECT, .value={.selector=1, .value1=0}}, .height={.tag=INTEROP_TAG_OBJECT, .value={.selector=1, .value1=0}}}})`)
...
function checkTabContent() {
    ...
    // Builder SubTabBarStyle and BottomTabBarStyle do not provide get method for properties
    const subTabBarStyle: SubTabBarStyle = new SubTabBarStyle("ContentResource")
        .id("subId")
        .padding({right: 10})

    const bottomTabBarStyle: BottomTabBarStyle = new BottomTabBarStyle("Icon", "Text")
        .padding({right: 10})
        .id("bottomId")
