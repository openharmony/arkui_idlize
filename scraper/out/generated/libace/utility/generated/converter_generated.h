...
ASSIGN_OPT(Opt_CheckboxModifier)
...
ASSIGN_OPT(Opt_ColumnModifier)
ASSIGN_OPT(Opt_ColumnSplitModifier)
...
ASSIGN_OPT(Opt_ContainerSpanModifier)
...
ASSIGN_OPT(Opt_DividerAttribute)
ASSIGN_OPT(Opt_DividerMode)
ASSIGN_OPT(Opt_DividerModifier)
...
ASSIGN_OPT(Opt_Edges_Arkui_Component_Enums_BorderStyle)
...
ASSIGN_OPT(Opt_GridColAttribute)
ASSIGN_OPT(Opt_GridColModifier)
ASSIGN_OPT(Opt_GridDirection)
ASSIGN_OPT(Opt_GridItemAlignment)
ASSIGN_OPT(Opt_GridItemAttribute)
ASSIGN_OPT(Opt_GridItemModifier)
ASSIGN_OPT(Opt_GridItemStyle)
ASSIGN_OPT(Opt_GridModifier)
ASSIGN_OPT(Opt_GridRowAttribute)
ASSIGN_OPT(Opt_GridRowDirection)
ASSIGN_OPT(Opt_GridRowModifier)
...
ASSIGN_OPT(Opt_HyperlinkModifier)
...
ASSIGN_OPT(Opt_ImageSpanModifier)
...
ASSIGN_OPT(Opt_LineModifier)
ASSIGN_OPT(Opt_ListAttribute)
ASSIGN_OPT(Opt_ListItemAlign)
ASSIGN_OPT(Opt_ListItemAttribute)
ASSIGN_OPT(Opt_ListItemGroupArea)
ASSIGN_OPT(Opt_ListItemGroupAttribute)
ASSIGN_OPT(Opt_ListItemGroupModifier)
ASSIGN_OPT(Opt_ListItemGroupStyle)
ASSIGN_OPT(Opt_ListItemModifier)
ASSIGN_OPT(Opt_ListItemStyle)
ASSIGN_OPT(Opt_ListModifier)
...
ASSIGN_OPT(Opt_MarqueeAttribute)
...
ASSIGN_OPT(Opt_MenuItemModifier)
ASSIGN_OPT(Opt_MenuModifier)
...
ASSIGN_OPT(Opt_NavDestinationModifier)
ASSIGN_OPT(Opt_NavigationAttribute)
ASSIGN_OPT(Opt_NavigationMode)
ASSIGN_OPT(Opt_NavigationModifier)
...
ASSIGN_OPT(Opt_PolygonModifier)
ASSIGN_OPT(Opt_PolylineModifier)
...
ASSIGN_OPT(Opt_RectModifier)
ASSIGN_OPT(Opt_RectResult)
ASSIGN_OPT(Opt_RefreshModifier)
ASSIGN_OPT(Opt_RefreshStatus)
ASSIGN_OPT(Opt_RelateType)
ASSIGN_OPT(Opt_RelativeContainerAttribute)
ASSIGN_OPT(Opt_RelativeContainerModifier)
...
ASSIGN_OPT(Opt_RichEditorModifier)
...
ASSIGN_OPT(Opt_RowAttribute)
ASSIGN_OPT(Opt_RowModifier)
ASSIGN_OPT(Opt_RowOptionsV2)
ASSIGN_OPT(Opt_RowSplitModifier)
...
ASSIGN_OPT(Opt_SideBarContainerAttribute)
ASSIGN_OPT(Opt_SideBarContainerModifier)
ASSIGN_OPT(Opt_SideBarContainerType)
ASSIGN_OPT(Opt_SideBarPosition)
ASSIGN_OPT(Opt_Size)
ASSIGN_OPT(Opt_SizeResult)
ASSIGN_OPT(Opt_SizeT)
...
ASSIGN_OPT(Opt_SpanModifier)
ASSIGN_OPT(Opt_SpringMotion)
ASSIGN_OPT(Opt_SpringProp)
ASSIGN_OPT(Opt_SslError)
ASSIGN_OPT(Opt_SslErrorHandler)
ASSIGN_OPT(Opt_StackAttribute)
ASSIGN_OPT(Opt_StackModifier)
ASSIGN_OPT(Opt_StepperAttribute)
ASSIGN_OPT(Opt_StepperModifier)
...
ASSIGN_OPT(Opt_SymbolSpanModifier)
...
ASSIGN_OPT(Opt_TextAreaModifier)
...
ASSIGN_OPT(Opt_TextInputModifier)
...
ASSIGN_OPT(Opt_XComponentAttribute)
...
ASSIGN_OPT(Opt_Array_FrameNode)
...
ASSIGN_OPT(Opt_Callback_Opt_Scene_Opt_Array_String_Void)
...
ASSIGN_OPT(Opt_UserViewBuilder)
...
ASSIGN_OPT(Opt_Corners_Arkui_Graphics_Vector2)
ASSIGN_OPT(Opt_Corners_Number)
ASSIGN_OPT(Opt_CrossLanguageOptions)
...
ASSIGN_OPT(Opt_TypedFrameNode)
ASSIGN_OPT(Opt_typeNode_BlankFrameNode)
ASSIGN_OPT(Opt_typeNode_ColumnFrameNode)
ASSIGN_OPT(Opt_typeNode_DividerFrameNode)
ASSIGN_OPT(Opt_typeNode_FlexFrameNode)
ASSIGN_OPT(Opt_typeNode_FlowItemFrameNode)
ASSIGN_OPT(Opt_typeNode_GridColFrameNode)
ASSIGN_OPT(Opt_typeNode_GridFrameNode)
ASSIGN_OPT(Opt_typeNode_GridItemFrameNode)
ASSIGN_OPT(Opt_typeNode_GridRowFrameNode)
ASSIGN_OPT(Opt_typeNode_ListFrameNode)
ASSIGN_OPT(Opt_typeNode_ListItemFrameNode)
ASSIGN_OPT(Opt_typeNode_ListItemGroupFrameNode)
ASSIGN_OPT(Opt_typeNode_MarqueeFrameNode)
ASSIGN_OPT(Opt_typeNode_RelativeContainerFrameNode)
ASSIGN_OPT(Opt_typeNode_RowFrameNode)
ASSIGN_OPT(Opt_typeNode_ScrollFrameNode)
ASSIGN_OPT(Opt_typeNode_SearchFrameNode)
ASSIGN_OPT(Opt_typeNode_StackFrameNode)
ASSIGN_OPT(Opt_typeNode_SwiperFrameNode)
ASSIGN_OPT(Opt_typeNode_SymbolGlyphFrameNode)
ASSIGN_OPT(Opt_typeNode_TextAreaFrameNode)
ASSIGN_OPT(Opt_typeNode_TextFrameNode)
ASSIGN_OPT(Opt_typeNode_TextInputFrameNode)
ASSIGN_OPT(Opt_typeNode_WaterFlowFrameNode)
ASSIGN_OPT(Opt_typeNode_XComponentFrameNode)
...
ASSIGN_OPT(Opt_WrappedBuilder_Arkui_Component_Builder_CustomBuilder)
