                         ...
                         const Opt_Number* value)
{
    ...
    // IndicatorComponentModelNG::SetSetInitialIndex(frameNode, convValue);
}
                  ...
                  const Opt_Number* value)
{
    ...
    CHECK_NULL_VOID(frameNode);
    //auto convValue = value ? Converter::OptConvert<type>(*value) : std::nullopt;
    // IndicatorComponentModelNG::SetSetCount(frameNode, convValue);
}
                  ...
                  const Opt_Union_DotIndicator_DigitIndicator* value)
{
    ...
    CHECK_NULL_VOID(frameNode);
    //auto convValue = value ? Converter::OptConvert<type>(*value) : std::nullopt;
    // IndicatorComponentModelNG::SetSetStyle(frameNode, convValue);
}
                 ...
                 const Opt_Boolean* value)
{
    ...
    CHECK_NULL_VOID(frameNode);
    //auto convValue = value ? Converter::OptConvert<type>(*value) : std::nullopt;
    // IndicatorComponentModelNG::SetSetLoop(frameNode, convValue);
}
                     ...
                     const Opt_Boolean* value)
{
    ...
    CHECK_NULL_VOID(frameNode);
    //auto convValue = value ? Converter::OptConvert<type>(*value) : std::nullopt;
    // IndicatorComponentModelNG::SetSetVertical(frameNode, convValue);
}
                     ...
                     const Opt_Callback_Number_Void* value)
{
    ...
    CHECK_NULL_VOID(frameNode);
    //auto convValue = value ? Converter::OptConvert<type>(*value) : std::nullopt;
    // IndicatorComponentModelNG::SetSetOnChange(frameNode, convValue);
}
