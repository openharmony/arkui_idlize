...
#ifndef OH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_H
#define OH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_H
...
#define OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_API_VERSION 1
...
typedef InteropRuntimeType OH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_RuntimeType;
...
typedef InteropCallbackResource OH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_CallbackResource;
...
typedef InteropVMContext OH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_VMContext;
typedef InteropAsyncWorker OH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_AsyncWorker;
typedef InteropAsyncWorkerPtr OH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_AsyncWorkerPtr;
typedef InteropBuffer OH_Buffer;
typedef InteropFunction OH_Function;
typedef InteropObject OH_Object;

typedef enum OH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_APIKind {
    OH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_API_KIND = 10
} OH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_APIKind;
...
typedef struct OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_ApplicationStateChangeCallbackPeer OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_ApplicationStateChangeCallbackPeer;
typedef struct OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_ApplicationStateChangeCallbackPeer* OH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_ApplicationStateChangeCallback;
typedef struct Opt_ApplicationStateChangeCallback Opt_ApplicationStateChangeCallback;
typedef struct Opt_Object Opt_Object;
typedef OH_Object OH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_Object;
typedef struct Opt_Int32 {
    OH_Tag tag;
    OH_Int32 value;
} Opt_Int32;
typedef struct Opt_ApplicationStateChangeCallback {
    OH_Tag tag;
    OH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_ApplicationStateChangeCallback value;
} Opt_ApplicationStateChangeCallback;
typedef struct Opt_Object {
    OH_Tag tag;
    OH_Object value;
} Opt_Object;
struct OH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_ApplicationStateChangeCallbackHandleOpaque;
typedef struct OH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_ApplicationStateChangeCallbackHandleOpaque* OH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_ApplicationStateChangeCallbackHandle;
typedef struct OH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_ApplicationStateChangeCallbackModifier {
    OH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_ApplicationStateChangeCallbackHandle (*construct)();
    void (*destruct)(OH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_ApplicationStateChangeCallbackHandle thisPtr);
    void (*onApplicationForeground)(OH_NativePointer thisPtr);
    void (*onApplicationBackground)(OH_NativePointer thisPtr);
} OH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_ApplicationStateChangeCallbackModifier;
typedef struct OH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_API {
    OH_Int32 version;
    const OH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_ApplicationStateChangeCallbackModifier* (*ApplicationStateChangeCallback)();
} OH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_API;
...
#endif // OH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_H
/* clang-format on */