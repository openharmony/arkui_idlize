...
#define KOALA_INTEROP_MODULE OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACKNativeModule
...
template <>
inline OH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_RuntimeType runtimeType(const OH_Int32& value)
{
...
template <>
inline OH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_RuntimeType runtimeType(const Opt_Int32& value)
{
    return (value.tag != INTEROP_TAG_UNDEFINED) ? (INTEROP_RUNTIME_OBJECT) : (INTEROP_RUNTIME_UNDEFINED);
}
template <>
inline OH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_RuntimeType runtimeType(const OH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_ApplicationStateChangeCallback& value)
{
    return INTEROP_RUNTIME_OBJECT;
}
template <>
inline void WriteToString(std::string* result, const OH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_ApplicationStateChangeCallback value) {
    WriteToString(result, static_cast<InteropNativePointer>(value));
}
template <>
inline void WriteToString(std::string* result, const Opt_ApplicationStateChangeCallback* value) {
    result->append("{.tag=");
    result->append(tagNameExact(reinterpret_cast<OH_Tag>(value->tag)));
    result->append(", .value=");
    if (value->tag != INTEROP_TAG_UNDEFINED) {
...
template <>
inline OH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_RuntimeType runtimeType(const Opt_ApplicationStateChangeCallback& value)
{
    return (value.tag != INTEROP_TAG_UNDEFINED) ? (INTEROP_RUNTIME_OBJECT) : (INTEROP_RUNTIME_UNDEFINED);
}
template <>
...
template <>
inline OH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_RuntimeType runtimeType(const Opt_Object& value)
{
    return (value.tag != INTEROP_TAG_UNDEFINED) ? (INTEROP_RUNTIME_OBJECT) : (INTEROP_RUNTIME_UNDEFINED);
}
class ApplicationStateChangeCallback_serializer {
    public:
    static void write(SerializerBase& buffer, OH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_ApplicationStateChangeCallback value);
    static OH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_ApplicationStateChangeCallback read(DeserializerBase& buffer);
};
inline void ApplicationStateChangeCallback_serializer::write(SerializerBase& buffer, OH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_ApplicationStateChangeCallback value)
{
    SerializerBase& valueSerializer = buffer;
    valueSerializer.writePointer(value);
}
inline OH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_ApplicationStateChangeCallback ApplicationStateChangeCallback_serializer::read(DeserializerBase& buffer)
{
    DeserializerBase& valueDeserializer = buffer;
    OH_NativePointer ptr = valueDeserializer.readPointer();
    return static_cast<OH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_ApplicationStateChangeCallback>(ptr);
}
const OH_AnyAPI* GetAnyImpl(int kind, int version, std::string* result = nullptr);
static const OH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_API* GetOH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_API(int32_t apiVersion) {
    return reinterpret_cast<const OH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_API*>(
        GetAnyImpl(static_cast<int>(OH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_APIKind::OH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_API_KIND),
        apiVersion, nullptr));
}
OH_NativePointer impl_CommonShapeMethod_construct(OH_Int32 id, OH_Int32 flags) {
        return GetOH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_API(OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_API_VERSION)->CommonShapeMethod()->construct(id, flags);
}
...
void impl_CommonShapeMethod_setOffset(OH_NativePointer thisPtr, KSerializerBuffer thisArray, int32_t thisLength) {
        ...
        GetOH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_API(OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_API_VERSION)->CommonShapeMethod()->setOffset(thisPtr, static_cast<OH_CustomObject*>(&valueValueTemp));
}
...
void impl_CommonShapeMethod_setFill(OH_NativePointer thisPtr, KSerializerBuffer thisArray, int32_t thisLength) {
        DeserializerBase thisDeserializer(thisArray, thisLength);
        OH_CustomObject valueValueTemp = static_cast<OH_CustomObject>(thisDeserializer.readCustomObject("object"));;
        GetOH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_API(OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_API_VERSION)->CommonShapeMethod()->setFill(thisPtr, static_cast<OH_CustomObject*>(&valueValueTemp));
}
...
void impl_CommonShapeMethod_setPosition(OH_NativePointer thisPtr, KSerializerBuffer thisArray, int32_t thisLength) {
        DeserializerBase thisDeserializer(thisArray, thisLength);
        OH_CustomObject valueValueTemp = static_cast<OH_CustomObject>(thisDeserializer.readCustomObject("object"));;
        GetOH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_API(OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_API_VERSION)->CommonShapeMethod()->setPosition(thisPtr, static_cast<OH_CustomObject*>(&valueValueTemp));
}
KOALA_INTEROP_DIRECT_V3(CommonShapeMethod_setPosition, OH_NativePointer, KSerializerBuffer, int32_t)

// Accessors

OH_NativePointer impl_ApplicationStateChangeCallback_construct() {
        return GetOH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_API(OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_API_VERSION)->ApplicationStateChangeCallback()->construct();
}
KOALA_INTEROP_DIRECT_0(ApplicationStateChangeCallback_construct, OH_NativePointer)
OH_NativePointer impl_ApplicationStateChangeCallback_getFinalizer() {
        return (OH_NativePointer) GetOH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_API(OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_API_VERSION)->ApplicationStateChangeCallback()->destruct;
}
KOALA_INTEROP_DIRECT_0(ApplicationStateChangeCallback_getFinalizer, OH_NativePointer)
void impl_ApplicationStateChangeCallback_onApplicationForeground(OH_NativePointer thisPtr) {
        GetOH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_API(OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_API_VERSION)->ApplicationStateChangeCallback()->onApplicationForeground(thisPtr);
}
KOALA_INTEROP_DIRECT_V1(ApplicationStateChangeCallback_onApplicationForeground, OH_NativePointer)
void impl_ApplicationStateChangeCallback_onApplicationBackground(OH_NativePointer thisPtr) {
        GetOH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_API(OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_API_VERSION)->ApplicationStateChangeCallback()->onApplicationBackground(thisPtr);
}
KOALA_INTEROP_DIRECT_V1(ApplicationStateChangeCallback_onApplicationBackground, OH_NativePointer)
...
void deserializeAndCallCallbackSync(OH_OHOS_APP_ABILITY_APPLICATIONSTATECHANGECALLBACK_VMContext vmContext, OH_Int32 kind, KSerializerBuffer thisArray, OH_Int32 thisLength)
{
    INTEROP_FATAL("Unknown callback kind");
}
