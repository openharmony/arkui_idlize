...
#ifndef OH_OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_H
#define OH_OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_H
...
#define OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_API_VERSION 1
...
typedef InteropRuntimeType OH_OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_RuntimeType;
...
typedef InteropCallbackResource OH_OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_CallbackResource;
...
typedef InteropVMContext OH_OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_VMContext;
typedef InteropAsyncWorker OH_OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_AsyncWorker;
typedef InteropAsyncWorkerPtr OH_OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_AsyncWorkerPtr;
typedef InteropBuffer OH_Buffer;
typedef InteropFunction OH_Function;
typedef InteropObject OH_Object;

typedef enum OH_OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_APIKind {
    OH_OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_API_KIND = 10
} OH_OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_APIKind;
...
typedef struct OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_image_PixelMapPeer OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_image_PixelMapPeer;
typedef struct OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_image_PixelMapPeer* OH_OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_image_PixelMap;
typedef struct Opt_image_PixelMap Opt_image_PixelMap;
typedef struct Opt_String Opt_String;
typedef struct OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_AtomicServiceOptionsPeer OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_AtomicServiceOptionsPeer;
typedef struct OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_AtomicServiceOptionsPeer* OH_OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_AtomicServiceOptions;
typedef struct Opt_AtomicServiceOptions Opt_AtomicServiceOptions;
typedef enum OH_OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_bundleManager_SupportWindowMode {
    OH_OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_BUNDLE_MANAGER_SUPPORT_WINDOW_MODE_FULL_SCREEN = 0,
    OH_OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_BUNDLE_MANAGER_SUPPORT_WINDOW_MODE_SPLIT = 1,
    OH_OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_BUNDLE_MANAGER_SUPPORT_WINDOW_MODE_FLOATING = 2,
} OH_OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_bundleManager_SupportWindowMode;
typedef struct Opt_bundleManager_SupportWindowMode {
    OH_Tag tag;
    OH_OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_bundleManager_SupportWindowMode value;
} Opt_bundleManager_SupportWindowMode;
typedef enum OH_OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_contextConstant_ProcessMode {
    OH_OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_CONTEXT_CONSTANT_PROCESS_MODE_NEW_PROCESS_ATTACH_TO_PARENT = 1,
    OH_OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_CONTEXT_CONSTANT_PROCESS_MODE_NEW_PROCESS_ATTACH_TO_STATUS_BAR_ITEM = 2,
    OH_OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_CONTEXT_CONSTANT_PROCESS_MODE_ATTACH_TO_STATUS_BAR_ITEM = 3,
} OH_OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_contextConstant_ProcessMode;
typedef struct Opt_contextConstant_ProcessMode {
    OH_Tag tag;
    OH_OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_contextConstant_ProcessMode value;
} Opt_contextConstant_ProcessMode;
typedef enum OH_OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_contextConstant_StartupVisibility {
    OH_OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_CONTEXT_CONSTANT_STARTUP_VISIBILITY_STARTUP_HIDE = 0,
    OH_OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_CONTEXT_CONSTANT_STARTUP_VISIBILITY_STARTUP_SHOW = 1,
} OH_OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_contextConstant_StartupVisibility;
typedef struct Opt_contextConstant_StartupVisibility {
    OH_Tag tag;
    OH_OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_contextConstant_StartupVisibility value;
...
typedef struct Array_bundleManager_SupportWindowMode {
    /* kind: ContainerType */
    OH_OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_bundleManager_SupportWindowMode* array;
    OH_Int32 length;
...
typedef struct Opt_image_PixelMap {
    OH_Tag tag;
    OH_OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_image_PixelMap value;
} Opt_image_PixelMap;
typedef struct Opt_String {
    OH_Tag tag;
    OH_String value;
} Opt_String;
typedef struct Opt_AtomicServiceOptions {
    OH_Tag tag;
    OH_OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_AtomicServiceOptions value;
} Opt_AtomicServiceOptions;
struct OH_OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_AtomicServiceOptionsHandleOpaque;
typedef struct OH_OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_AtomicServiceOptionsHandleOpaque* OH_OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_AtomicServiceOptionsHandle;
typedef struct OH_OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_AtomicServiceOptionsModifier {
    OH_OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_AtomicServiceOptionsHandle (*construct)();
    void (*destruct)(OH_OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_AtomicServiceOptionsHandle thisPtr);
    Opt_Int32 (*getFlags)(OH_NativePointer thisPtr);
    void (*setFlags)(OH_NativePointer thisPtr, const Opt_Int32* value);
    Opt_Map_String_Object (*getParameters)(OH_NativePointer thisPtr);
    void (*setParameters)(OH_NativePointer thisPtr, const Opt_Map_String_Object* value);
} OH_OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_AtomicServiceOptionsModifier;
typedef struct OH_OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_API {
    OH_Int32 version;
    const OH_OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_AtomicServiceOptionsModifier* (*AtomicServiceOptions)();
} OH_OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_API;
...
#endif // OH_OHOS_APP_ABILITY_ATOMICSERVICEOPTIONS_H
/* clang-format on */