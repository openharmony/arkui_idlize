...
#ifndef OH_OHOS_APP_ABILITY_WANT_H
#define OH_OHOS_APP_ABILITY_WANT_H
...
#define OHOS_APP_ABILITY_WANT_API_VERSION 1
...
typedef InteropRuntimeType OH_OHOS_APP_ABILITY_WANT_RuntimeType;
...
typedef InteropCallbackResource OH_OHOS_APP_ABILITY_WANT_CallbackResource;
...
typedef InteropVMContext OH_OHOS_APP_ABILITY_WANT_VMContext;
typedef InteropAsyncWorker OH_OHOS_APP_ABILITY_WANT_AsyncWorker;
typedef InteropAsyncWorkerPtr OH_OHOS_APP_ABILITY_WANT_AsyncWorkerPtr;
typedef InteropBuffer OH_Buffer;
typedef InteropFunction OH_Function;
typedef InteropObject OH_Object;

typedef enum OH_OHOS_APP_ABILITY_WANT_APIKind {
    OH_OHOS_APP_ABILITY_WANT_API_KIND = 10
} OH_OHOS_APP_ABILITY_WANT_APIKind;
...
typedef struct OHOS_APP_ABILITY_WANT_WantPeer OHOS_APP_ABILITY_WANT_WantPeer;
typedef struct OHOS_APP_ABILITY_WANT_WantPeer* OH_OHOS_APP_ABILITY_WANT_Want;
...
typedef struct Opt_Want {
    OH_Tag tag;
    OH_OHOS_APP_ABILITY_WANT_Want value;
} Opt_Want;
struct OH_OHOS_APP_ABILITY_WANT_WantHandleOpaque;
typedef struct OH_OHOS_APP_ABILITY_WANT_WantHandleOpaque* OH_OHOS_APP_ABILITY_WANT_WantHandle;
typedef struct OH_OHOS_APP_ABILITY_WANT_WantModifier {
    OH_OHOS_APP_ABILITY_WANT_WantHandle (*construct)();
    void (*destruct)(OH_OHOS_APP_ABILITY_WANT_WantHandle thisPtr);
    Opt_String (*getBundleName)(OH_NativePointer thisPtr);
    void (*setBundleName)(OH_NativePointer thisPtr, const Opt_String* value);
    Opt_String (*getAbilityName)(OH_NativePointer thisPtr);
    void (*setAbilityName)(OH_NativePointer thisPtr, const Opt_String* value);
    Opt_String (*getDeviceId)(OH_NativePointer thisPtr);
    void (*setDeviceId)(OH_NativePointer thisPtr, const Opt_String* value);
    Opt_String (*getUri)(OH_NativePointer thisPtr);
    void (*setUri)(OH_NativePointer thisPtr, const Opt_String* value);
    Opt_String (*getType)(OH_NativePointer thisPtr);
    void (*setType)(OH_NativePointer thisPtr, const Opt_String* value);
    Opt_Int32 (*getFlags)(OH_NativePointer thisPtr);
    void (*setFlags)(OH_NativePointer thisPtr, const Opt_Int32* value);
    Opt_String (*getAction)(OH_NativePointer thisPtr);
    void (*setAction)(OH_NativePointer thisPtr, const Opt_String* value);
    ...
    Opt_Array_String (*getEntities)(OH_NativePointer thisPtr);
    void (*setEntities)(OH_NativePointer thisPtr, const Opt_Array_String* value);
    Opt_String (*getModuleName)(OH_NativePointer thisPtr);
    void (*setModuleName)(OH_NativePointer thisPtr, const Opt_String* value);
    Opt_Map_String_Int32 (*getFds)(OH_NativePointer thisPtr);
} OH_OHOS_APP_ABILITY_WANT_WantModifier;
typedef struct OH_OHOS_APP_ABILITY_WANT_API {
    OH_Int32 version;
    const OH_OHOS_APP_ABILITY_WANT_WantModifier* (*Want)();
} OH_OHOS_APP_ABILITY_WANT_API;
...
#endif // OH_OHOS_APP_ABILITY_WANT_H
/* clang-format on */