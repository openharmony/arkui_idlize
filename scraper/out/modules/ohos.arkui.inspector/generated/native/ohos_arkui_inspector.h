...
#ifndef OH_OHOS_ARKUI_INSPECTOR_H
#define OH_OHOS_ARKUI_INSPECTOR_H
...
#define OHOS_ARKUI_INSPECTOR_API_VERSION 1
...
typedef InteropRuntimeType OH_OHOS_ARKUI_INSPECTOR_RuntimeType;
...
typedef InteropCallbackResource OH_OHOS_ARKUI_INSPECTOR_CallbackResource;
...
typedef InteropVMContext OH_OHOS_ARKUI_INSPECTOR_VMContext;
typedef InteropAsyncWorker OH_OHOS_ARKUI_INSPECTOR_AsyncWorker;
typedef InteropAsyncWorkerPtr OH_OHOS_ARKUI_INSPECTOR_AsyncWorkerPtr;
typedef InteropBuffer OH_Buffer;
typedef InteropFunction OH_Function;
typedef InteropObject OH_Object;

typedef enum OH_OHOS_ARKUI_INSPECTOR_APIKind {
    OH_OHOS_ARKUI_INSPECTOR_API_KIND = 10
} OH_OHOS_ARKUI_INSPECTOR_APIKind;
...
typedef struct OHOS_ARKUI_INSPECTOR_inspector_ComponentObserverPeer OHOS_ARKUI_INSPECTOR_inspector_ComponentObserverPeer;
typedef struct OHOS_ARKUI_INSPECTOR_inspector_ComponentObserverPeer* OH_OHOS_ARKUI_INSPECTOR_inspector_ComponentObserver;
typedef struct Opt_inspector_ComponentObserver Opt_inspector_ComponentObserver;
typedef struct OHOS_ARKUI_INSPECTOR_inspector_Callback_Void OHOS_ARKUI_INSPECTOR_inspector_Callback_Void;
typedef struct Opt_OHOS_ARKUI_INSPECTOR_inspector_Callback_Void Opt_OHOS_ARKUI_INSPECTOR_inspector_Callback_Void;
typedef struct Opt_Object Opt_Object;
typedef OH_Object OH_OHOS_ARKUI_INSPECTOR_Object;
...
typedef struct Opt_inspector_ComponentObserver {
    OH_Tag tag;
    OH_OHOS_ARKUI_INSPECTOR_inspector_ComponentObserver value;
} Opt_inspector_ComponentObserver;
typedef struct OHOS_ARKUI_INSPECTOR_inspector_Callback_Void {
    /* kind: Callback */
    OH_OHOS_ARKUI_INSPECTOR_CallbackResource resource;
    void (*call)(const OH_Int32 resourceId);
    void (*callSync)(OH_OHOS_ARKUI_INSPECTOR_VMContext vmContext, const OH_Int32 resourceId);
} OHOS_ARKUI_INSPECTOR_inspector_Callback_Void;
typedef struct Opt_OHOS_ARKUI_INSPECTOR_inspector_Callback_Void {
    OH_Tag tag;
    OHOS_ARKUI_INSPECTOR_inspector_Callback_Void value;
} Opt_OHOS_ARKUI_INSPECTOR_inspector_Callback_Void;
typedef struct Opt_Object {
    OH_Tag tag;
    OH_Object value;
} Opt_Object;
struct OH_OHOS_ARKUI_INSPECTOR_inspector_ComponentObserverHandleOpaque;
typedef struct OH_OHOS_ARKUI_INSPECTOR_inspector_ComponentObserverHandleOpaque* OH_OHOS_ARKUI_INSPECTOR_inspector_ComponentObserverHandle;
typedef struct OH_OHOS_ARKUI_INSPECTOR_inspector_ComponentObserverModifier {
    OH_OHOS_ARKUI_INSPECTOR_inspector_ComponentObserverHandle (*construct)();
    void (*destruct)(OH_OHOS_ARKUI_INSPECTOR_inspector_ComponentObserverHandle thisPtr);
    void (*onLayoutLayout)(OH_NativePointer thisPtr, const OHOS_ARKUI_INSPECTOR_inspector_Callback_Void* callback_);
    void (*offLayoutLayout)(OH_NativePointer thisPtr, const Opt_OHOS_ARKUI_INSPECTOR_inspector_Callback_Void* callback_);
    void (*onDrawDraw)(OH_NativePointer thisPtr, const OHOS_ARKUI_INSPECTOR_inspector_Callback_Void* callback_);
    void (*offDrawDraw)(OH_NativePointer thisPtr, const Opt_OHOS_ARKUI_INSPECTOR_inspector_Callback_Void* callback_);
    void (*onDrawChildrenDrawChildren)(OH_NativePointer thisPtr, const OHOS_ARKUI_INSPECTOR_inspector_Callback_Void* callback_);
    void (*offDrawChildrenDrawChildren)(OH_NativePointer thisPtr, const Opt_OHOS_ARKUI_INSPECTOR_inspector_Callback_Void* callback_);
} OH_OHOS_ARKUI_INSPECTOR_inspector_ComponentObserverModifier;
typedef struct OH_OHOS_ARKUI_INSPECTOR_API {
    OH_Int32 version;
    const OH_OHOS_ARKUI_INSPECTOR_inspector_ComponentObserverModifier* (*Inspector_ComponentObserver)();
} OH_OHOS_ARKUI_INSPECTOR_API;
...
#endif // OH_OHOS_ARKUI_INSPECTOR_H
/* clang-format on */