...
export type AbilityCallbackFn = (ability: object) => void;
export type WindowStageCallbackFn = (ability: object, windowStage: window.WindowStage) => void;
export interface InteropAbilityLifecycleCallback {
