...
#ifndef OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_H
#define OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_H
...
#define OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_API_VERSION 1
...
typedef InteropRuntimeType OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_RuntimeType;
...
typedef InteropCallbackResource OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_CallbackResource;
...
typedef InteropVMContext OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_VMContext;
typedef InteropAsyncWorker OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_AsyncWorker;
typedef InteropAsyncWorkerPtr OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_AsyncWorkerPtr;
typedef InteropBuffer OH_Buffer;
typedef InteropFunction OH_Function;
typedef InteropObject OH_Object;

typedef enum OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_APIKind {
    OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_API_KIND = 10
} OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_APIKind;
...
typedef struct OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_EnvironmentCallbackPeer OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_EnvironmentCallbackPeer;
typedef struct OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_EnvironmentCallbackPeer* OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_EnvironmentCallback;
typedef struct Opt_EnvironmentCallback Opt_EnvironmentCallback;
typedef struct Opt_String Opt_String;
typedef struct OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_Configuration OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_Configuration;
typedef struct Opt_Configuration Opt_Configuration;
typedef struct Opt_Object Opt_Object;
typedef OH_Object OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_Object;
typedef enum OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_AbilityConstant_MemoryLevel {
    OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_ABILITY_CONSTANT_MEMORY_LEVEL_MEMORY_LEVEL_MODERATE = 0,
    OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_ABILITY_CONSTANT_MEMORY_LEVEL_MEMORY_LEVEL_LOW = 1,
    OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_ABILITY_CONSTANT_MEMORY_LEVEL_MEMORY_LEVEL_CRITICAL = 2,
} OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_AbilityConstant_MemoryLevel;
typedef struct Opt_AbilityConstant_MemoryLevel {
    OH_Tag tag;
    OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_AbilityConstant_MemoryLevel value;
} Opt_AbilityConstant_MemoryLevel;
typedef enum OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_ConfigurationConstant_ColorMode {
    OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_CONFIGURATION_CONSTANT_COLOR_MODE_COLOR_MODE_NOT_SET = -1,
    OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_CONFIGURATION_CONSTANT_COLOR_MODE_COLOR_MODE_DARK = 0,
    OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_CONFIGURATION_CONSTANT_COLOR_MODE_COLOR_MODE_LIGHT = 1,
} OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_ConfigurationConstant_ColorMode;
typedef struct Opt_ConfigurationConstant_ColorMode {
    OH_Tag tag;
    OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_ConfigurationConstant_ColorMode value;
} Opt_ConfigurationConstant_ColorMode;
typedef enum OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_ConfigurationConstant_Direction {
    OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_CONFIGURATION_CONSTANT_DIRECTION_DIRECTION_NOT_SET = -1,
    OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_CONFIGURATION_CONSTANT_DIRECTION_DIRECTION_VERTICAL = 0,
    OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_CONFIGURATION_CONSTANT_DIRECTION_DIRECTION_HORIZONTAL = 1,
} OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_ConfigurationConstant_Direction;
typedef struct Opt_ConfigurationConstant_Direction {
    OH_Tag tag;
    OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_ConfigurationConstant_Direction value;
} Opt_ConfigurationConstant_Direction;
typedef enum OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_ConfigurationConstant_ScreenDensity {
    OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_CONFIGURATION_CONSTANT_SCREEN_DENSITY_SCREEN_DENSITY_NOT_SET = 0,
    OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_CONFIGURATION_CONSTANT_SCREEN_DENSITY_SCREEN_DENSITY_SDPI = 120,
    OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_CONFIGURATION_CONSTANT_SCREEN_DENSITY_SCREEN_DENSITY_MDPI = 160,
    OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_CONFIGURATION_CONSTANT_SCREEN_DENSITY_SCREEN_DENSITY_LDPI = 240,
    OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_CONFIGURATION_CONSTANT_SCREEN_DENSITY_SCREEN_DENSITY_XLDPI = 320,
    OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_CONFIGURATION_CONSTANT_SCREEN_DENSITY_SCREEN_DENSITY_XXLDPI = 480,
    OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_CONFIGURATION_CONSTANT_SCREEN_DENSITY_SCREEN_DENSITY_XXXLDPI = 640,
} OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_ConfigurationConstant_ScreenDensity;
typedef struct Opt_ConfigurationConstant_ScreenDensity {
    OH_Tag tag;
    OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_ConfigurationConstant_ScreenDensity value;
...
typedef struct Opt_EnvironmentCallback {
    OH_Tag tag;
    OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_EnvironmentCallback value;
} Opt_EnvironmentCallback;
typedef struct Opt_String {
    OH_Tag tag;
    OH_String value;
} Opt_String;
typedef struct OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_Configuration {
    /* kind: Interface */
    Opt_String language;
    ...
    Opt_String mcc;
    Opt_String mnc;
} OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_Configuration;
...
struct OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_EnvironmentCallbackHandleOpaque;
typedef struct OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_EnvironmentCallbackHandleOpaque* OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_EnvironmentCallbackHandle;
typedef struct OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_EnvironmentCallbackModifier {
    OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_EnvironmentCallbackHandle (*construct)();
    void (*destruct)(OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_EnvironmentCallbackHandle thisPtr);
    void (*onConfigurationUpdated)(OH_NativePointer thisPtr, const OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_Configuration* config);
    void (*onMemoryLevel)(OH_NativePointer thisPtr, OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_AbilityConstant_MemoryLevel level);
} OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_EnvironmentCallbackModifier;
typedef struct OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_API {
    OH_Int32 version;
    const OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_EnvironmentCallbackModifier* (*EnvironmentCallback)();
} OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_API;
...
#endif // OH_OHOS_APP_ABILITY_ENVIRONMENTCALLBACK_H
/* clang-format on */