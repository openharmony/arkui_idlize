...
#ifndef OH_OHOS_BASE_H
#define OH_OHOS_BASE_H
...
#define OHOS_BASE_API_VERSION 1
...
typedef InteropRuntimeType OH_OHOS_BASE_RuntimeType;
...
typedef InteropCallbackResource OH_OHOS_BASE_CallbackResource;
...
typedef InteropVMContext OH_OHOS_BASE_VMContext;
typedef InteropAsyncWorker OH_OHOS_BASE_AsyncWorker;
typedef InteropAsyncWorkerPtr OH_OHOS_BASE_AsyncWorkerPtr;
typedef InteropBuffer OH_Buffer;
typedef InteropFunction OH_Function;
typedef InteropObject OH_Object;

typedef enum OH_OHOS_BASE_APIKind {
    OH_OHOS_BASE_API_KIND = 10
} OH_OHOS_BASE_APIKind;
...
typedef struct OHOS_BASE_BusinessErrorPeer OHOS_BASE_BusinessErrorPeer;
typedef struct OHOS_BASE_BusinessErrorPeer* OH_OHOS_BASE_BusinessError;
typedef struct Opt_BusinessError Opt_BusinessError;
typedef struct Opt_Object Opt_Object;
typedef OH_Object OH_OHOS_BASE_Object;
...
struct OH_OHOS_BASE_BusinessErrorHandleOpaque;
typedef struct OH_OHOS_BASE_BusinessErrorHandleOpaque* OH_OHOS_BASE_BusinessErrorHandle;
typedef struct OH_OHOS_BASE_BusinessErrorModifier {
    OH_OHOS_BASE_BusinessErrorHandle (*construct0)();
    OH_OHOS_BASE_BusinessErrorHandle (*construct1)(OH_Int32 code, const OH_CustomObject* error);
    OH_OHOS_BASE_BusinessErrorHandle (*construct2)(OH_Int32 code, const OH_CustomObject* data, const OH_CustomObject* error);
    void (*destruct)(OH_OHOS_BASE_BusinessErrorHandle thisPtr);
    OH_Int32 (*getCode)(OH_NativePointer thisPtr);
    void (*setCode)(OH_NativePointer thisPtr, OH_Int32 value);
    Opt_CustomObject (*getData)(OH_NativePointer thisPtr);
    void (*setData)(OH_NativePointer thisPtr, const Opt_CustomObject* value);
} OH_OHOS_BASE_BusinessErrorModifier;
typedef struct OH_OHOS_BASE_API {
    OH_Int32 version;
    const OH_OHOS_BASE_BusinessErrorModifier* (*BusinessError)();
} OH_OHOS_BASE_API;
