...
#ifndef OH_OHOS_CURVES_H
#define OH_OHOS_CURVES_H
...
#define OHOS_CURVES_API_VERSION 1
...
typedef InteropRuntimeType OH_OHOS_CURVES_RuntimeType;
...
typedef InteropCallbackResource OH_OHOS_CURVES_CallbackResource;
...
typedef InteropVMContext OH_OHOS_CURVES_VMContext;
typedef InteropAsyncWorker OH_OHOS_CURVES_AsyncWorker;
typedef InteropAsyncWorkerPtr OH_OHOS_CURVES_AsyncWorkerPtr;
typedef InteropBuffer OH_Buffer;
typedef InteropFunction OH_Function;
typedef InteropObject OH_Object;

typedef enum OH_OHOS_CURVES_APIKind {
    OH_OHOS_CURVES_API_KIND = 10
} OH_OHOS_CURVES_APIKind;
...
typedef struct OHOS_CURVES_curves_ICurvePeer OHOS_CURVES_curves_ICurvePeer;
typedef struct OHOS_CURVES_curves_ICurvePeer* OH_OHOS_CURVES_curves_ICurve;
typedef struct Opt_curves_ICurve Opt_curves_ICurve;
typedef struct Opt_Object Opt_Object;
typedef OH_Object OH_OHOS_CURVES_Object;
typedef enum OH_OHOS_CURVES_curves_Curve {
    OH_OHOS_CURVES_CURVES_CURVE_LINEAR = 0,
    OH_OHOS_CURVES_CURVES_CURVE_EASE = 1,
    OH_OHOS_CURVES_CURVES_CURVE_EASE_IN = 2,
    OH_OHOS_CURVES_CURVES_CURVE_EASE_OUT = 3,
    OH_OHOS_CURVES_CURVES_CURVE_EASE_IN_OUT = 4,
    OH_OHOS_CURVES_CURVES_CURVE_FAST_OUT_SLOW_IN = 5,
    OH_OHOS_CURVES_CURVES_CURVE_LINEAR_OUT_SLOW_IN = 6,
    OH_OHOS_CURVES_CURVES_CURVE_FAST_OUT_LINEAR_IN = 7,
    OH_OHOS_CURVES_CURVES_CURVE_EXTREME_DECELERATION = 8,
    OH_OHOS_CURVES_CURVES_CURVE_SHARP = 9,
    OH_OHOS_CURVES_CURVES_CURVE_RHYTHM = 10,
    OH_OHOS_CURVES_CURVES_CURVE_SMOOTH = 11,
    OH_OHOS_CURVES_CURVES_CURVE_FRICTION = 12,
} OH_OHOS_CURVES_curves_Curve;
typedef struct Opt_curves_Curve {
    OH_Tag tag;
    OH_OHOS_CURVES_curves_Curve value;
} Opt_curves_Curve;
...
typedef struct Opt_curves_ICurve {
    OH_Tag tag;
    OH_OHOS_CURVES_curves_ICurve value;
} Opt_curves_ICurve;
typedef struct Opt_Object {
    OH_Tag tag;
    OH_Object value;
} Opt_Object;
struct OH_OHOS_CURVES_curves_ICurveHandleOpaque;
typedef struct OH_OHOS_CURVES_curves_ICurveHandleOpaque* OH_OHOS_CURVES_curves_ICurveHandle;
typedef struct OH_OHOS_CURVES_curves_ICurveModifier {
    OH_OHOS_CURVES_curves_ICurveHandle (*construct)();
    void (*destruct)(OH_OHOS_CURVES_curves_ICurveHandle thisPtr);
    OH_Number (*interpolate)(OH_NativePointer thisPtr, const OH_Number* fraction);
} OH_OHOS_CURVES_curves_ICurveModifier;
typedef struct OH_OHOS_CURVES_API {
    OH_Int32 version;
    const OH_OHOS_CURVES_curves_ICurveModifier* (*Curves_ICurve)();
} OH_OHOS_CURVES_API;
