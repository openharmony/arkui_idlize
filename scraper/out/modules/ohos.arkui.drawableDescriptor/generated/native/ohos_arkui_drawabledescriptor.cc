...
#define KOALA_INTEROP_MODULE OHOS_ARKUI_DRAWABLEDESCRIPTORNativeModule
...
template <>
inline OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_RuntimeType runtimeType(const OH_Int32& value)
{
...
template <>
inline OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_RuntimeType runtimeType(const Opt_Int32& value)
{
    return (value.tag != INTEROP_TAG_UNDEFINED) ? (INTEROP_RUNTIME_OBJECT) : (INTEROP_RUNTIME_UNDEFINED);
}
template <>
inline OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_RuntimeType runtimeType(const OH_Boolean& value)
{
...
template <>
inline OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_RuntimeType runtimeType(const Opt_Boolean& value)
{
    return (value.tag != INTEROP_TAG_UNDEFINED) ? (INTEROP_RUNTIME_OBJECT) : (INTEROP_RUNTIME_UNDEFINED);
}
template <>
inline OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_RuntimeType runtimeType(const OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_DrawableDescriptor& value)
{
    return INTEROP_RUNTIME_OBJECT;
}
template <>
inline void WriteToString(std::string* result, const OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_DrawableDescriptor value) {
...
template <>
inline OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_RuntimeType runtimeType(const Opt_DrawableDescriptor& value)
{
    return (value.tag != INTEROP_TAG_UNDEFINED) ? (INTEROP_RUNTIME_OBJECT) : (INTEROP_RUNTIME_UNDEFINED);
}
template <>
inline OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_RuntimeType runtimeType(const OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_image_PixelMap& value)
{
    return INTEROP_RUNTIME_OBJECT;
}
template <>
inline void WriteToString(std::string* result, const OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_image_PixelMap value) {
    WriteToString(result, static_cast<InteropNativePointer>(value));
}
template <>
...
template <>
inline OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_RuntimeType runtimeType(const Opt_image_PixelMap& value)
{
    return (value.tag != INTEROP_TAG_UNDEFINED) ? (INTEROP_RUNTIME_OBJECT) : (INTEROP_RUNTIME_UNDEFINED);
}
template <>
...
template <>
inline OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_RuntimeType runtimeType(const Opt_Object& value)
{
    return (value.tag != INTEROP_TAG_UNDEFINED) ? (INTEROP_RUNTIME_OBJECT) : (INTEROP_RUNTIME_UNDEFINED);
}
class DrawableDescriptor_serializer {
    public:
    static void write(SerializerBase& buffer, OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_DrawableDescriptor value);
    static OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_DrawableDescriptor read(DeserializerBase& buffer);
};
class image_PixelMap_serializer {
    public:
    static void write(SerializerBase& buffer, OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_image_PixelMap value);
    static OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_image_PixelMap read(DeserializerBase& buffer);
};
inline void DrawableDescriptor_serializer::write(SerializerBase& buffer, OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_DrawableDescriptor value)
{
    SerializerBase& valueSerializer = buffer;
    valueSerializer.writePointer(value);
}
inline OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_DrawableDescriptor DrawableDescriptor_serializer::read(DeserializerBase& buffer)
{
    DeserializerBase& valueDeserializer = buffer;
    OH_NativePointer ptr = valueDeserializer.readPointer();
    return static_cast<OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_DrawableDescriptor>(ptr);
}
inline void image_PixelMap_serializer::write(SerializerBase& buffer, OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_image_PixelMap value)
{
    SerializerBase& valueSerializer = buffer;
    valueSerializer.writePointer(value);
}
inline OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_image_PixelMap image_PixelMap_serializer::read(DeserializerBase& buffer)
{
    DeserializerBase& valueDeserializer = buffer;
    OH_NativePointer ptr = valueDeserializer.readPointer();
    return static_cast<OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_image_PixelMap>(ptr);
}
const OH_AnyAPI* GetAnyImpl(int kind, int version, std::string* result = nullptr);
static const OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_API* GetOH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_API(int32_t apiVersion) {
    return reinterpret_cast<const OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_API*>(
        GetAnyImpl(static_cast<int>(OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_APIKind::OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_API_KIND),
        apiVersion, nullptr));
}
OH_NativePointer impl_CommonShapeMethod_construct(OH_Int32 id, OH_Int32 flags) {
        return GetOH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_API(OHOS_ARKUI_DRAWABLEDESCRIPTOR_API_VERSION)->CommonShapeMethod()->construct(id, flags);
}
...
void impl_CommonShapeMethod_setOffset(OH_NativePointer thisPtr, KSerializerBuffer thisArray, int32_t thisLength) {
        ...
        GetOH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_API(OHOS_ARKUI_DRAWABLEDESCRIPTOR_API_VERSION)->CommonShapeMethod()->setOffset(thisPtr, static_cast<OH_CustomObject*>(&valueValueTemp));
}
...
void impl_CommonShapeMethod_setFill(OH_NativePointer thisPtr, KSerializerBuffer thisArray, int32_t thisLength) {
        DeserializerBase thisDeserializer(thisArray, thisLength);
        OH_CustomObject valueValueTemp = static_cast<OH_CustomObject>(thisDeserializer.readCustomObject("object"));;
        GetOH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_API(OHOS_ARKUI_DRAWABLEDESCRIPTOR_API_VERSION)->CommonShapeMethod()->setFill(thisPtr, static_cast<OH_CustomObject*>(&valueValueTemp));
}
...
void impl_CommonShapeMethod_setPosition(OH_NativePointer thisPtr, KSerializerBuffer thisArray, int32_t thisLength) {
        DeserializerBase thisDeserializer(thisArray, thisLength);
        OH_CustomObject valueValueTemp = static_cast<OH_CustomObject>(thisDeserializer.readCustomObject("object"));;
        GetOH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_API(OHOS_ARKUI_DRAWABLEDESCRIPTOR_API_VERSION)->CommonShapeMethod()->setPosition(thisPtr, static_cast<OH_CustomObject*>(&valueValueTemp));
}
KOALA_INTEROP_DIRECT_V3(CommonShapeMethod_setPosition, OH_NativePointer, KSerializerBuffer, int32_t)

// Accessors

OH_NativePointer impl_DrawableDescriptor_construct() {
        return GetOH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_API(OHOS_ARKUI_DRAWABLEDESCRIPTOR_API_VERSION)->DrawableDescriptor()->construct();
}
KOALA_INTEROP_DIRECT_0(DrawableDescriptor_construct, OH_NativePointer)
OH_NativePointer impl_DrawableDescriptor_getFinalizer() {
        return (OH_NativePointer) GetOH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_API(OHOS_ARKUI_DRAWABLEDESCRIPTOR_API_VERSION)->DrawableDescriptor()->destruct;
}
KOALA_INTEROP_DIRECT_0(DrawableDescriptor_getFinalizer, OH_NativePointer)
KInteropReturnBuffer impl_DrawableDescriptor_getPixelMap(OH_NativePointer thisPtr) {
        const auto &retValue = GetOH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_API(OHOS_ARKUI_DRAWABLEDESCRIPTOR_API_VERSION)->DrawableDescriptor()->getPixelMap(thisPtr);
...
KOALA_INTEROP_1(DrawableDescriptor_getPixelMap, KInteropReturnBuffer, OH_NativePointer)
...
void deserializeAndCallCallbackSync(OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_VMContext vmContext, OH_Int32 kind, KSerializerBuffer thisArray, OH_Int32 thisLength)
{
    INTEROP_FATAL("Unknown callback kind");
}
