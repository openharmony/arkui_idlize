...
#ifndef OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_H
#define OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_H
...
#define OHOS_ARKUI_DRAWABLEDESCRIPTOR_API_VERSION 1
...
typedef InteropRuntimeType OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_RuntimeType;
...
typedef InteropCallbackResource OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_CallbackResource;
...
typedef InteropVMContext OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_VMContext;
typedef InteropAsyncWorker OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_AsyncWorker;
typedef InteropAsyncWorkerPtr OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_AsyncWorkerPtr;
typedef InteropBuffer OH_Buffer;
typedef InteropFunction OH_Function;
typedef InteropObject OH_Object;

typedef enum OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_APIKind {
    OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_API_KIND = 10
} OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_APIKind;
...
typedef struct OHOS_ARKUI_DRAWABLEDESCRIPTOR_DrawableDescriptorPeer OHOS_ARKUI_DRAWABLEDESCRIPTOR_DrawableDescriptorPeer;
typedef struct OHOS_ARKUI_DRAWABLEDESCRIPTOR_DrawableDescriptorPeer* OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_DrawableDescriptor;
typedef struct Opt_DrawableDescriptor Opt_DrawableDescriptor;
typedef struct OHOS_ARKUI_DRAWABLEDESCRIPTOR_image_PixelMapPeer OHOS_ARKUI_DRAWABLEDESCRIPTOR_image_PixelMapPeer;
typedef struct OHOS_ARKUI_DRAWABLEDESCRIPTOR_image_PixelMapPeer* OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_image_PixelMap;
typedef struct Opt_image_PixelMap Opt_image_PixelMap;
typedef struct Opt_Object Opt_Object;
typedef OH_Object OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_Object;
...
typedef struct Opt_DrawableDescriptor {
    OH_Tag tag;
    OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_DrawableDescriptor value;
} Opt_DrawableDescriptor;
typedef struct Opt_image_PixelMap {
    OH_Tag tag;
    OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_image_PixelMap value;
} Opt_image_PixelMap;
typedef struct Opt_Object {
    OH_Tag tag;
    OH_Object value;
} Opt_Object;
struct OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_DrawableDescriptorHandleOpaque;
typedef struct OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_DrawableDescriptorHandleOpaque* OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_DrawableDescriptorHandle;
typedef struct OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_DrawableDescriptorModifier {
    OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_DrawableDescriptorHandle (*construct)();
    void (*destruct)(OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_DrawableDescriptorHandle thisPtr);
    Opt_image_PixelMap (*getPixelMap)(OH_NativePointer thisPtr);
} OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_DrawableDescriptorModifier;
typedef struct OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_API {
    OH_Int32 version;
    const OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_DrawableDescriptorModifier* (*DrawableDescriptor)();
} OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_API;
...
#endif // OH_OHOS_ARKUI_DRAWABLEDESCRIPTOR_H
/* clang-format on */