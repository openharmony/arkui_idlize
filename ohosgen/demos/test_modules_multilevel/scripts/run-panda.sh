...
LD_LIBRARY_PATH=$PWD/$out_dir $arkts_dir/ark $out_dir/app.abc --ark-boot-files $bootfiles --ark-entry-point @test-modules-multilevel.src.panda.main.ETSGLOBAL::main
