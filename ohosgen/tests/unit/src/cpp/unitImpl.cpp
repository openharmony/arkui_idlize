...
void ForceCallbackClass_registerListenerImpl(OH_NativePointer thisPtr, const OH_UNIT_ForceCallbackListener* listener)
{
    ...
    resourceHold(forceCallbackListener.onStatus.resource);
    resourceHold(forceCallbackListener.onChange.resource);
}
...
void forceCallbackOnChangeCallSyncContinuation(
    OH_UNIT_VMContext context, const OH_Int32 resourceId, const OH_String value)
{
...
OH_Number ForceCallbackClass_callListenerImpl(OH_NativePointer thisPtr)
{
    ...
    resourceRelease(forceCallbackListener.onChange.resource);
...
OH_UNIT_OrdinaryEnum GlobalScope_checkOrdinaryEnumsImpl(OH_UNIT_OrdinaryEnum value1, OH_UNIT_OrdinaryEnum value2)
{
    if (value1 != OH_UNIT_ORDINARY_ENUM_E1) {
        INTEROP_FATAL(
            "Enum param value1 %d does not equal OH_UNIT_ORDINARY_ENUM_E1: %d", value1, OH_UNIT_ORDINARY_ENUM_E1);
    }
    if (value2 != OH_UNIT_ORDINARY_ENUM_E2) {
        INTEROP_FATAL(
            "Enum param value2 %d does not equal OH_UNIT_ORDINARY_ENUM_E2: %d", value2, OH_UNIT_ORDINARY_ENUM_E2);
    }
...
OH_UNIT_IntEnumNegative GlobalScope_checkIntNegativeEnumsImpl(
    OH_UNIT_IntEnumNegative value1, OH_UNIT_IntEnumNegative value2)
{
    int8_t enumValueE1 = -1;
    int8_t enumValueE2 = -3;
    int8_t enumValueE3 = -15;
    if (OH_UNIT_INT_ENUM_NEGATIVE_E1 != enumValueE1) {
        INTEROP_FATAL(
            "Enum OH_UNIT_INT_ENUM_NEGATIVE_E1 %d does not equal to: %d", OH_UNIT_INT_ENUM_NEGATIVE_E1, enumValueE1);
    }
    if (OH_UNIT_INT_ENUM_NEGATIVE_E3 != enumValueE2) {
        INTEROP_FATAL(
...
{
    int32_t expectedE4 = 0x4;
    int32_t expectedEAB = 0xAB;
    int32_t expectedECD = 0xCD;
    if (OH_UNIT_HEX_ENUM_E4 != expectedE4) {
        INTEROP_FATAL("Enum OH_UNIT_HEX_ENUM_E4 %d does not equal to: %d", OH_UNIT_HEX_ENUM_E4, expectedE4);
    }
    if (OH_UNIT_HEX_ENUM_EAB != expectedEAB) {
        INTEROP_FATAL("Enum OH_UNIT_HEX_ENUM_EAB %d does not equal to: %d", OH_UNIT_HEX_ENUM_EAB, expectedEAB);
    }
    if (OH_UNIT_HEX_ENUM_ECD != expectedECD) {
        INTEROP_FATAL("Enum OH_UNIT_HEX_ENUM_ECD %d does not equal to: %d", OH_UNIT_HEX_ENUM_ECD, expectedECD);
    }
...
{
    int32_t expectedE0 = 0b0;
    int32_t expectedE101 = 0b101;
    int32_t expectedE10010 = 0b10010;
    if (OH_UNIT_BIN_ENUM_E0 != expectedE0) {
        INTEROP_FATAL("Enum OH_UNIT_BIN_ENUM_E0 %d does not equal to: %d", OH_UNIT_BIN_ENUM_E0, expectedE0);
    }
    if (OH_UNIT_BIN_ENUM_E101 != expectedE101) {
        INTEROP_FATAL("Enum OH_UNIT_BIN_ENUM_E101 %d does not equal to: %d", OH_UNIT_BIN_ENUM_E101, expectedE101);
    }
    if (OH_UNIT_BIN_ENUM_E10010 != expectedE10010) {
        INTEROP_FATAL("Enum OH_UNIT_BIN_ENUM_E10010 %d does not equal to: %d", OH_UNIT_BIN_ENUM_E10010, expectedE10010);
    }
    if (value1 != OH_UNIT_BIN_ENUM_E1) {
        INTEROP_FATAL("Enum param value1 %d does not equal OH_UNIT_BIN_ENUM_E1: %d", value1, OH_UNIT_BIN_ENUM_E1);
    }
    if (value2 != OH_UNIT_BIN_ENUM_E101) {
        INTEROP_FATAL("Enum param value2 %d does not equal OH_UNIT_BIN_ENUM_E101: %d", value1, OH_UNIT_BIN_ENUM_E101);
    }
...
OH_UNIT_DuplicateIntEnum GlobalScope_checkDuplicateIntEnumsImpl(
    OH_UNIT_DuplicateIntEnum value1, OH_UNIT_DuplicateIntEnum value2)
{
    ...
    if (OH_UNIT_DUPLICATE_INT_ENUM_THIRD != OH_UNIT_DUPLICATE_INT_ENUM_LEGACY_THIRD) {
        INTEROP_FATAL(
            "Enum OH_UNIT_DUPLICATE_INT_ENUM_THIRD %d does not equal OH_UNIT_DUPLICATE_INT_ENUM_LEGACY_THIRD: %d",
...
// Needs: do not generate construct and destruct methods for static materialized
...
void test_materialized_classes_MaterializedOverloadedMethods_destructImpl(
    OH_UNIT_test_materialized_classes_MaterializedOverloadedMethodsHandle thisPtr)
{
    delete reinterpret_cast<OH_UNIT_test_materialized_classes_MaterializedOverloadedMethodsHandle*>(thisPtr);
}

void test_materialized_classes_MaterializedOverloadedMethods_method1Impl(
    OH_NativePointer thisPtr, const Opt_Boolean* valBoolean, const Opt_String* valString)
{
...
void test_materialized_classes_MaterializedMoreOverloadedMethods_destructImpl(
    OH_UNIT_test_materialized_classes_MaterializedMoreOverloadedMethodsHandle thisPtr)
{
...
{
    return reinterpret_cast<const OH_UNIT_test_materialized_classes_MaterializedWithConstructorAndFieldsPeer*>(thisPtr)
        ->valNumber;
}
void test_materialized_classes_MaterializedWithConstructorAndFields_setValNumberImpl(
    OH_NativePointer thisPtr, const OH_Number* value)
{
    reinterpret_cast<OH_UNIT_test_materialized_classes_MaterializedWithConstructorAndFieldsPeer*>(thisPtr)->valNumber =
        *value;
}
...
OH_UNIT_test_materialized_classes_MaterializedWithCreateMethodHandle
    test_materialized_classes_MaterializedWithCreateMethod_constructImpl(/** todo: where is constructor params? */)
{
...
void test_materialized_classes_MaterializedComplexArguments_destructImpl(
    OH_UNIT_test_materialized_classes_MaterializedComplexArgumentsHandle thisPtr)
{
...
Array_String GlobalScope_test_return_types_returnStringArrayImpl()
{
    ...
    for (int i = 0; i < arrayLength; ++i) {
        ...
        int32_t testLength = 3;
        arr.array[i].length = testLength;
    }
    return arr;
}
...
OH_Boolean CheckCallbackExceptions_checkThrowableCallbackI32_withParameterImpl(
    OH_UNIT_VMContext vmContext, OH_NativePointer thisPtr, const UNIT_ThrowableCallbackI32_withParameter* value)
{
...
OH_Boolean CheckCallbackExceptions_checkThrowableCallbackI32Impl(
    OH_UNIT_VMContext vmContext, OH_NativePointer thisPtr, const UNIT_ThrowableCallbackI32* value)
{
    static bool gotException = false;
    gotException = false;
    value->callSync(vmContext, value->resource.resourceId,
...
OH_Boolean GlobalScope_testLengthImpl(const OH_Number* step, const OH_UNIT_Length* value)
{
    ...
    if (s == one) {
        constexpr int32_t value0 = 0;
        constexpr int32_t value1 = 1;
        constexpr int32_t value2 = 2;
        switch (u.selector) {
            case value0:
                return (u.value0.length == strlen("length") && strcmp("length", u.value0.chars) == 0);
            case value1: {
                int32_t expectedValue = 123;
                return (u.value1.tag == INTEROP_TAG_INT32 && u.value1.i32 == expectedValue);
            }
            case value2:
                return OH_TRUE; // Needs: Resource
            default:
                INTEROP_FATAL("Not correct GlobalScope_testLengthImpl argument value");
        }
    } else if (s == two) {
        constexpr int32_t value0 = 0;
        constexpr int32_t value1 = 1;
        ...
        switch (u.selector) {
            case value0:
                return (u.value0.length == strlen("") && strcmp("", u.value0.chars) == 0);
            case value1: {
                float expectedValue = 456.789f;
                float tolerance = 0.1f;
                return (u.value1.tag == INTEROP_TAG_FLOAT32 && fabs(u.value1.f32 - expectedValue) < tolerance);
            }
            case value2:
                return OH_TRUE; // Needs: Resource
            default:
...
OH_UNIT_UnionSampleNumberArrayInterface GlobalScope_checkUnionNumberArraySampleImpl(
    const OH_UNIT_UnionSampleNumberArrayInterface* value)
{
    return *value;
}
OH_UNIT_UnionSampleTupleArrayInterface GlobalScope_checkUnionTupleArraySampleImpl(
    const OH_UNIT_UnionSampleTupleArrayInterface* value)
{
    return *value;
}
OH_UNIT_UnionSampleGenericTypeInterface GlobalScope_checkUnionGenericTypeSampleImpl(
    const OH_UNIT_UnionSampleGenericTypeInterface* value)
{
    return *value;
}
...
UNIT_TransformDstCallbackI GlobalScope_checkTransformSrcIToCallbackImpl(
    const UNIT_TransformDstCallbackI* value, OH_Boolean flag)
{
    value->resource.hold(value->resource.resourceId);
    return *value;
}

UNIT_TransformDstCallbackC GlobalScope_checkTransformSrcCToCallbackImpl(
    const UNIT_TransformDstCallbackC* value, OH_Boolean flag)
{
    value->resource.hold(value->resource.resourceId);
    return *value;
}
...
OH_String ChildC_childMethodImpl(
    OH_NativePointer thisPtr, const OH_String* childText, OH_Boolean childFlag, const OH_Number* childCount)
{
