...
void main_resizeImpl(const OH_TEST_FQN_Sizes* arg) {
...
void main_resize3Impl(
    const OH_TEST_FQN_main_Size* numSize,
    const OH_TEST_FQN_deps_Size* intSize,
    const OH_TEST_FQN_deps_fp_Size* floatSize
) {
