...
OH_TEST_MODULES_MULTILEVEL_FooInt bar_BarInt_getXImpl(OH_NativePointer thisPtr) {
...
void bar_BarInt_setXImpl(OH_NativePointer thisPtr, OH_TEST_MODULES_MULTILEVEL_FooInt value) {
    std::cout << "BarInt_setXImpl(thisPtr, value)" << std::endl;
    auto* obj = reinterpret_cast<MyBarInt*>(thisPtr);
    obj->x = *reinterpret_cast<MyFooInt*>(value);
}

OH_TEST_MODULES_MULTILEVEL_FooInt bar_BarInt_getYImpl(OH_NativePointer thisPtr) {
    std::cout << "BarInt_getYImpl(thisPtr)" << std::endl;
    return reinterpret_cast<OH_TEST_MODULES_MULTILEVEL_FooInt>(
        &reinterpret_cast<MyBarInt*>(thisPtr)->y);
}

void bar_BarInt_setYImpl(OH_NativePointer thisPtr, OH_TEST_MODULES_MULTILEVEL_FooInt value) {
    std::cout << "BarInt_setYImpl(thisPtr, value)" << std::endl;
    auto* obj = reinterpret_cast<MyBarInt*>(thisPtr);
    obj->y = *reinterpret_cast<MyFooInt*>(value);
}

OH_NativePointer baz_BazInt_constructImpl(
...
OH_TEST_MODULES_MULTILEVEL_FooInt baz_BazInt_getFooImpl(OH_NativePointer thisPtr) {
    std::cout << "BazInt_getFooImpl(thisPtr)" << std::endl;
    auto* obj = reinterpret_cast<MyBazInt*>(thisPtr);
    return reinterpret_cast<OH_TEST_MODULES_MULTILEVEL_FooInt>(&obj->foo);
}

void baz_BazInt_setFooImpl(OH_NativePointer thisPtr, OH_TEST_MODULES_MULTILEVEL_FooInt value) {
    std::cout << "BazInt_setFooImpl(thisPtr, value)" << std::endl;
    auto* obj = reinterpret_cast<MyBazInt*>(thisPtr);
    obj->foo = *reinterpret_cast<MyFooInt*>(value);
}

OH_TEST_MODULES_MULTILEVEL_BarInt baz_BazInt_getBarImpl(OH_NativePointer thisPtr) {
    std::cout << "BazInt_getBarImpl(thisPtr)" << std::endl;
    auto* obj = reinterpret_cast<MyBazInt*>(thisPtr);
    return reinterpret_cast<OH_TEST_MODULES_MULTILEVEL_BarInt>(&obj->bar);
}

void baz_BazInt_setBarImpl(OH_NativePointer thisPtr, OH_TEST_MODULES_MULTILEVEL_BarInt value) {
    std::cout << "BazInt_setBarImpl(thisPtr, value)" << std::endl;
    auto* obj = reinterpret_cast<MyBazInt*>(thisPtr);
    obj->bar = *reinterpret_cast<MyBarInt*>(value);
}

OH_Number qux_qux_getIntWithFooImpl(OH_TEST_MODULES_MULTILEVEL_FooInt foo) {
...
OH_Number qux_qux_getIntWithBarImpl(OH_TEST_MODULES_MULTILEVEL_BarInt bar, const OH_Number* offset) {
