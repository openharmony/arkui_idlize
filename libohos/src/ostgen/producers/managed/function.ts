...
export const func: OhosProducer<idl.IDLMethod> = (method, ctx) => {
...
export const ctor: OhosProducer<idl.IDLConstructor> = (ctor, ctx) => {
        // reference: E.v(managedName(idl.getFQName(ctor))),
  const className = managedName(idl.getFQName(ctor.parent!))
  return {
    continuation: E.v(managedName(idl.getFQName(ctor.parent!))),
    declarations: [
