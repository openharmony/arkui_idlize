...
|`onGeolocationShow`| Function | Erokhin Ilya | done | dependency on Ark_JsGeolocation |
...
|`onErrorReceive`| Function | Erokhin Ilya | done | dependency on Ark_WebResourceRequest & Ark_WebResourceError |
|`onHttpErrorReceive`| Function | Erokhin Ilya | done | dependency on Ark_WebResourceRequest & Ark_WebResourceResponse |
...
|`onFullScreenEnter`| Function | Erokhin Ilya | done | dependency on Ark_FullScreenExitHandler |
...
|`onPermissionRequest`| Function | Erokhin Ilya | done | dependency Ark_PermissionRequest |
|`onScreenCaptureRequest`| Function | Erokhin Ilya | done | dependency on Ark_ScreenCaptureHandler |
...
|`onScroll`| Function | Erokhin Ilya | done | |
|`onSslErrorEventReceive`| Function | Erokhin Ilya | done | dependency on Ark_SslErrorHandler |
|`onSslErrorEvent`| Function | Erokhin Ilya | done | dependency on Ark_SslErrorHandler |
...
|`onDataResubmitted`| Function | Erokhin Ilya | done | dependency on Ark_DataResubmissionHandler |
