...
export const IDLPrimitiveTypeNames = ["pointer", "void", "boolean", "i8", "u8", "i16", "u16", "i32", "u32", "i64", "u64", "f16", "f32", "f64", "bigint", "number", "String", "any", "undefined", "unknown", "Object", "this", "date", "buffer", "SerializerBuffer", "Function", "CustomObject", "InteropReturnBuffer", "Exception"] as const
