...
param3: ((__memo_context: __memo_context_type, __memo_id: __memo_id_type) => void) | ((__memo_context: __memo_context_type, __memo_id: __memo_id_type, x?: number) => number) | undefined) {
    const __memo_scope = __memo_context.scope<void>(__memo_id + ("3___key_id_DIRNAME/union_type_parameters.ts" as __memo_id_type), 3, undefined, undefined, undefined, undefined);
    const __memo_parameter_param1 = __memo_scope.param(0, param1, undefined, undefined, undefined);
    const __memo_parameter_param2 = __memo_scope.param(1, param2, undefined, undefined, undefined);
    const __memo_parameter_param3 = __memo_scope.param(2, param3, undefined, undefined, undefined);
