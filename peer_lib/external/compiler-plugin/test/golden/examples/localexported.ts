...
function entry(__memo_context: __memo_context_type, __memo_id: __memo_id_type) {
    const __memo_scope = __memo_context.scope<void>(__memo_id + ("1___key_id_DIRNAME/localexported.ts" as __memo_id_type), undefined, undefined, undefined, undefined, undefined);
