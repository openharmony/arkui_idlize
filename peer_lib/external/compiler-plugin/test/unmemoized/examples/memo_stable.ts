...
class X {
    ...
    methodX(__memo_context: __memo_context_type, __memo_id: __memo_id_type): this {
        const __memo_scope = __memo_context.scope<this>(__memo_id + "0___key_id_DIRNAME/memo_stable.ts", 1);
...
class Y {
    ...
    methodY(__memo_context: __memo_context_type, __memo_id: __memo_id_type): this {
        const __memo_scope = __memo_context.scope<this>(__memo_id + "1___key_id_DIRNAME/memo_stable.ts");
        if (__memo_scope.unchanged)
            return __memo_scope.cached;
        const d = this;
...
class Z {
    ...
    methodZ(__memo_context: __memo_context_type, __memo_id: __memo_id_type) {
        const __memo_scope = __memo_context.scope<void>(__memo_id + "3___key_id_DIRNAME/memo_stable.ts");
        if (__memo_scope.unchanged)
            return __memo_scope.cached;
        const d = this;
        class W {
            ...
            methodW(__memo_context: __memo_context_type, __memo_id: __memo_id_type) {
                const __memo_scope = __memo_context.scope<void>(__memo_id + "2___key_id_DIRNAME/memo_stable.ts", 1);
                const __memo_parameter_this = __memo_scope.param(0, this);
                if (__memo_scope.unchanged)
                    return __memo_scope.cached;
