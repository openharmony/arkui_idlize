...
param3: ((__memo_context: __memo_context_type, __memo_id: __memo_id_type) => void) | ((__memo_context: __memo_context_type, __memo_id: __memo_id_type, x?: number) => number) | undefined) {
    const __memo_scope = __memo_context.scope<void>(__memo_id + "3___key_id_DIRNAME/union_type_parameters.ts", 3);
    ...
    __memo_parameter_param1.value?.(__memo_context, __memo_id + "0___key_id_DIRNAME/union_type_parameters.ts");
    __memo_parameter_param2.value?.(__memo_context, __memo_id + "1___key_id_DIRNAME/union_type_parameters.ts");
    __memo_parameter_param3.value?.(__memo_context, __memo_id + "2___key_id_DIRNAME/union_type_parameters.ts");
