...
export class PersistenceV2 {
    ...
    public static connect<T extends object>(
        ...
        return PersistenceV2Impl.instance().connect(
        ttype, transferTypeName(ttype.getName()), toJson, fromJson, defaultCreator);
    }
...
export class PersistenceV2Impl {
    ...
    constructor() {
        ...
        this.globalKeysArr_ = [new Set<string>(), new Set<string>(), new Set<string>(), new Set<string>(
            ), new Set<string>()];
