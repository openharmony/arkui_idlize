...
// Function with poor spacing around template parameters and operators
template<typename T>
T Max(T a,T b){
return (a>b)?a:b;
}

// Long line without proper breaks that exceeds the maximum line length limit
void ProcessLongParameterList(int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10) {
    // Implementation goes here with proper formatting
}
